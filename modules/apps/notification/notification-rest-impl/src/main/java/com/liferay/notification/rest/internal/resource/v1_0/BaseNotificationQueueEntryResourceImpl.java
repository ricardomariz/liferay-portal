...
public abstract class BaseNotificationQueueEntryResourceImpl
	implements EntityModelResource, NotificationQueueEntryResource,
			   VulcanBatchEngineTaskItemDelegate<NotificationQueueEntry>,
			   VulcanCRUDItemDelegate<NotificationQueueEntry> {
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/notification-queue-entries")
	...
	@javax.ws.rs.Path("/notification-queue-entries/export-batch")
	@javax.ws.rs.POST
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/notification-queue-entries/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/notification-queue-entries/{notificationQueueEntryId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public void create(
			Collection<NotificationQueueEntry> notificationQueueEntries,
	...
	public Page<NotificationQueueEntry> read(
		...
		return getNotificationQueueEntriesPage(
	...
	@Override
	public NotificationQueueEntry getItem(Long id) throws Exception {
		return getNotificationQueueEntry(id);
	}
