...
export class CTEntryApi {
	...
	public async getCtCollectionCTEntriesPage (ctCollectionId: number, filter?: string, page?: number, pageSize?: number, search?: string, showHideable?: boolean, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageCTEntry; }> {
		const localVarPath = this.basePath + '/change-tracking-rest/v1.0/ct-collections/{ctCollectionId}/ct-entries'.replace('{' + 'ctCollectionId' + '}', encodeURIComponent(String(ctCollectionId)));
	...
	public async getCtCollectionCTEntryByModelClassNameByModelClassPkModelClassPK (ctCollectionId: number, modelClassNameId: number, modelClassPK: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CTEntry; }> {
		const localVarPath = this.basePath + '/change-tracking-rest/v1.0/ct-collections/{ctCollectionId}/ct-entries/by-model-class-name-id/{modelClassNameId}/by-model-class-pk/{modelClassPK}'.replace('{' + 'ctCollectionId' + '}', encodeURIComponent(String(ctCollectionId))).replace('{' + 'modelClassNameId' + '}', encodeURIComponent(String(modelClassNameId))).replace('{' + 'modelClassPK' + '}', encodeURIComponent(String(modelClassPK)));
		let localVarQueryParameters: any = {};
		let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
		const produces = ['application/json', 'application/xml'];
		// give precedence to 'application/json'
	...
	public async getCTEntry (ctEntryId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CTEntry; }> {
		const localVarPath = this.basePath + '/change-tracking-rest/v1.0/ct-entries/{ctEntryId}'.replace('{' + 'ctEntryId' + '}', encodeURIComponent(String(ctEntryId)));
		let localVarQueryParameters: any = {};
		let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
		const produces = ['application/json', 'application/xml'];
		// give precedence to 'application/json'
