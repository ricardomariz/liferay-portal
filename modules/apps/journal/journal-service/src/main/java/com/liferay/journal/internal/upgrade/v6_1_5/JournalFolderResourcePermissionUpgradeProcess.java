 ...
 */
public class JournalFolderResourcePermissionUpgradeProcess
	extends UpgradeProcess {

	public JournalFolderResourcePermissionUpgradeProcess(
	...
	protected void doUpgrade() throws Exception {
		String resourcePermissionName = JournalFolder.class.getName();
