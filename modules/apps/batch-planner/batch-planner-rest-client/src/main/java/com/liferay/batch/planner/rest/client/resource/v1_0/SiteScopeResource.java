...
public interface SiteScopeResource {
	...
	public static class Builder {
		...
		public SiteScopeResource build() {
			return new SiteScopeResourceImpl(this);
		}
	...
	public static class SiteScopeResourceImpl implements SiteScopeResource {
		...
		public Page<SiteScope> getPlanInternalClassNameKeySiteScopesPage(
			...
			try {
				return Page.of(content, SiteScopeSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private SiteScopeResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SiteScopeResource.class.getName());
