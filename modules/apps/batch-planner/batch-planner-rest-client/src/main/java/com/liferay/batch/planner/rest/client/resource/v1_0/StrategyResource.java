...
public interface StrategyResource {
	...
	public static class Builder {
		...
		public StrategyResource build() {
			return new StrategyResourceImpl(this);
		}
	...
	public static class StrategyResourceImpl implements StrategyResource {
		...
		public Page<Strategy> getPlanInternalClassNameKeyStrategiesPage(
			...
			try {
				return Page.of(content, StrategySerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private StrategyResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			StrategyResource.class.getName());
