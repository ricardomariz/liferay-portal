...
package com.liferay.dispatch.rest.client.resource.v1_0;
 ...
 */
@Generated("")
public interface DispatchTriggerResource {
	...
	public void postDispatchTriggersPageExportBatch(
	...
	public HttpInvoker.HttpResponse postDispatchTriggerHttpResponse(
	...
	public static class Builder {
		...
		public DispatchTriggerResource build() {
			return new DispatchTriggerResourceImpl(this);
		}
	...
	public static class DispatchTriggerResourceImpl
		implements DispatchTriggerResource {

		public Page<DispatchTrigger> getDispatchTriggersPage()
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getDispatchTriggersPageHttpResponse();
			...
			try {
				return Page.of(content, DispatchTriggerSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public DispatchTrigger postDispatchTrigger(
				DispatchTrigger dispatchTrigger)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postDispatchTriggerHttpResponse(dispatchTrigger);
			...
			try {
				return DispatchTriggerSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postDispatchTriggerHttpResponse(
			...
			httpInvoker.body(dispatchTrigger.toString(), "application/json");
		...
		private DispatchTriggerResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DispatchTriggerResource.class.getName());
