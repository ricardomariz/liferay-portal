...
public interface StatusResource {
	...
	public HttpInvoker.HttpResponse getStatusHttpResponse() throws Exception;
	...
	public static class StatusResourceImpl implements StatusResource {
		...
		public Status getStatus() throws Exception {
			...
			try {
				return com.liferay.bulk.rest.client.serdes.v1_0.StatusSerDes.
					toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
		...
		public HttpInvoker.HttpResponse getStatusHttpResponse()
			throws Exception {
