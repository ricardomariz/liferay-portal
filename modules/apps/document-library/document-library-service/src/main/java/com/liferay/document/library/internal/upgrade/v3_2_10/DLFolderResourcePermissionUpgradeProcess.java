 ...
 */
public class DLFolderResourcePermissionUpgradeProcess extends UpgradeProcess {

	public DLFolderResourcePermissionUpgradeProcess(
	...
	protected void doUpgrade() throws Exception {
		String resourcePermissionName = DLFolder.class.getName();
