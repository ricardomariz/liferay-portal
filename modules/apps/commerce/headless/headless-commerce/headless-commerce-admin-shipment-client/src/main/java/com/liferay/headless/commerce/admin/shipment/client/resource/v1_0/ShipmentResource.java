...
public interface ShipmentResource {
	...
	public HttpInvoker.HttpResponse getShipmentsPageHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;

	public void postShipmentsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postShipmentsPageExportBatchHttpResponse(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getShipmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchShipmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Shipment shipment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putShipmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Shipment shipment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postShipmentByExternalReferenceCodeStatusDeliveredHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postShipmentByExternalReferenceCodeStatusFinishProcessingHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postShipmentByExternalReferenceCodeStatusShippedHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getShipmentHttpResponse(Long shipmentId)
		throws Exception;

	public Shipment patchShipment(Long shipmentId, Shipment shipment)
		throws Exception;

	public HttpInvoker.HttpResponse patchShipmentHttpResponse(
			Long shipmentId, Shipment shipment)
		throws Exception;

	public Shipment postShipmentStatusDelivered(Long shipmentId)
		throws Exception;

	public HttpInvoker.HttpResponse postShipmentStatusDeliveredHttpResponse(
			Long shipmentId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postShipmentStatusFinishProcessingHttpResponse(Long shipmentId)
		throws Exception;

	public Shipment postShipmentStatusShipped(Long shipmentId) throws Exception;

	public HttpInvoker.HttpResponse postShipmentStatusShippedHttpResponse(
			Long shipmentId)
		throws Exception;
	...
	public static class Builder {
		...
		public ShipmentResource build() {
			return new ShipmentResourceImpl(this);
		}
	...
	public static class ShipmentResourceImpl implements ShipmentResource {
		...
		public Page<Shipment> getShipmentsPage(
			...
			try {
				return Page.of(content, ShipmentSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public void postShipmentsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postShipmentsPageExportBatchHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/export-batch");
		...
		public Shipment postShipment(Shipment shipment) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postShipmentHttpResponse(
				shipment);
			...
			try {
				return ShipmentSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postShipmentHttpResponse(
				Shipment shipment)
			throws Exception {

			HttpInvoker httpInvoker = HttpInvoker.newHttpInvoker();

			httpInvoker.body(shipment.toString(), "application/json");
		...
		public HttpInvoker.HttpResponse postShipmentBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/by-externalReferenceCode/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/by-externalReferenceCode/{externalReferenceCode}/status-delivered");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/by-externalReferenceCode/{externalReferenceCode}/status-finish-processing");
		...
		public void deleteShipment(Long shipmentId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteShipmentHttpResponse(
				shipmentId);
		...
		public HttpInvoker.HttpResponse deleteShipmentHttpResponse(
				Long shipmentId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}");
		...
		public Shipment getShipment(Long shipmentId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getShipmentHttpResponse(
				shipmentId);
		...
		public Shipment patchShipment(Long shipmentId, Shipment shipment)
			...
			HttpInvoker.HttpResponse httpResponse = patchShipmentHttpResponse(
				shipmentId, shipment);
		...
		public Shipment postShipmentStatusDelivered(Long shipmentId)
			...
			HttpInvoker.HttpResponse httpResponse =
				postShipmentStatusDeliveredHttpResponse(shipmentId);
		...
		public HttpInvoker.HttpResponse postShipmentStatusDeliveredHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}/status-delivered");
		...
		public Shipment postShipmentStatusFinishProcessing(Long shipmentId)
			...
			HttpInvoker.HttpResponse httpResponse =
				postShipmentStatusFinishProcessingHttpResponse(shipmentId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}/status-finish-processing");
		...
		public Shipment postShipmentStatusShipped(Long shipmentId)
			...
			HttpInvoker.HttpResponse httpResponse =
				postShipmentStatusShippedHttpResponse(shipmentId);
		...
		public HttpInvoker.HttpResponse postShipmentStatusShippedHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-shipment/v1.0/shipments/{shipmentId}/status-shipped");
		...
		private ShipmentResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ShipmentResource.class.getName());
