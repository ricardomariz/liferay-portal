...
public interface WarehouseResource {
	...
	public HttpInvoker.HttpResponse
			getCommerceAdminSiteSettingGroupWarehousePageHttpResponse(
				Long groupId, Boolean active, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postCommerceAdminSiteSettingGroupWarehouseHttpResponse(
				Long groupId, Warehouse warehouse)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getWarehouseHttpResponse(Long id)
		throws Exception;

	public void putWarehouse(Long id, Warehouse warehouse) throws Exception;

	public HttpInvoker.HttpResponse putWarehouseHttpResponse(
	...
	public static class WarehouseResourceImpl implements WarehouseResource {
		...
		public void deleteWarehouse(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteWarehouseHttpResponse(
				id);
		...
		public Warehouse getWarehouse(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getWarehouseHttpResponse(
				id);
		...
		public void putWarehouse(Long id, Warehouse warehouse)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = putWarehouseHttpResponse(
				id, warehouse);
