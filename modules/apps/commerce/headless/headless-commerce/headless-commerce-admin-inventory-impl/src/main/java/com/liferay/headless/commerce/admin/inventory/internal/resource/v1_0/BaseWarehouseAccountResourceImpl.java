...
public abstract class BaseWarehouseAccountResourceImpl
	implements EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<WarehouseAccount>,
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "WarehouseAccount")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/warehouse-accounts/{warehouseAccountId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteWarehouseAccount(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("warehouseAccountId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-inventory/v1.0/warehouse-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/warehouse-accounts/batch")
	...
	public Response deleteWarehouseAccountBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				WarehouseAccount.class.getName(), callbackURL, object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/warehouses/by-externalReferenceCode/{externalReferenceCode}/warehouse-accounts"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/warehouses/{id}/warehouse-accounts")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-inventory/v1.0/warehouses/warehouse-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/warehouses/warehouse-accounts/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postWarehouseIdWarehouseAccountBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("callbackURL")
			String callbackURL,
			Object object)
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				WarehouseAccount.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public void create(
			Collection<WarehouseAccount> warehouseAccounts,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<WarehouseAccount, WarehouseAccount, Exception>
			warehouseAccountUnsafeFunction = null;
		...
		if (warehouseAccountUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for WarehouseAccount");
		}
	...
	@Override
	public Page<WarehouseAccount> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<WarehouseAccount>,
			 UnsafeConsumer<WarehouseAccount, Exception>, Exception>
