...
public abstract class BaseWarehouseAccountGroupResourceImpl
	implements EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<WarehouseAccountGroup>,
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/warehouse-account-groups/{warehouseAccountGroupId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteWarehouseAccountGroup(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("warehouseAccountGroupId")
			Long warehouseAccountGroupId)
		throws Exception {
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-inventory/v1.0/warehouse-account-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/warehouse-account-groups/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/warehouses/by-externalReferenceCode/{externalReferenceCode}/warehouse-account-groups"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/warehouses/{id}/warehouse-account-groups")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-inventory/v1.0/warehouses/warehouse-account-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/warehouses/warehouse-account-groups/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postWarehouseIdWarehouseAccountGroupBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				WarehouseAccountGroup.class.getName(), callbackURL, null,
				object)
		).build();
	}
	...
	public void create(
			Collection<WarehouseAccountGroup> warehouseAccountGroups,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<WarehouseAccountGroup, WarehouseAccountGroup, Exception>
			warehouseAccountGroupUnsafeFunction = null;
		...
		if (warehouseAccountGroupUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for WarehouseAccountGroup");
		}
	...
	@Override
	public Page<WarehouseAccountGroup> read(
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<WarehouseAccountGroup>,
			 UnsafeFunction
				 <WarehouseAccountGroup, WarehouseAccountGroup, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<WarehouseAccountGroup>,
			 UnsafeConsumer<WarehouseAccountGroup, Exception>, Exception>
