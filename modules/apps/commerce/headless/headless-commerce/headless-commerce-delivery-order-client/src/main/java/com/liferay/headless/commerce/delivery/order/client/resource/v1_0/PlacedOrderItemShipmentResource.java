...
public interface PlacedOrderItemShipmentResource {
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderItemPlacedOrderItemShipmentsPageHttpResponse(
				Long placedOrderItemId)
		throws Exception;

	public void postPlacedOrderItemPlacedOrderItemShipmentsPageExportBatch(
			Long placedOrderItemId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postPlacedOrderItemPlacedOrderItemShipmentsPageExportBatchHttpResponse(
				Long placedOrderItemId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public PlacedOrderItemShipmentResource build() {
			return new PlacedOrderItemShipmentResourceImpl(this);
		}
	...
	public static class PlacedOrderItemShipmentResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path("placedOrderItemId", placedOrderItemId);
		...
		public void postPlacedOrderItemPlacedOrderItemShipmentsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPlacedOrderItemPlacedOrderItemShipmentsPageExportBatchHttpResponse(
					placedOrderItemId, callbackURL, contentType, fieldNames);
		...
		public HttpInvoker.HttpResponse
				postPlacedOrderItemPlacedOrderItemShipmentsPageExportBatchHttpResponse(
					Long placedOrderItemId, String callbackURL,
		...
		private PlacedOrderItemShipmentResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PlacedOrderItemShipmentResource.class.getName());
