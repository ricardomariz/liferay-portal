...
public interface PlacedOrderItemResource {
	...
	public HttpInvoker.HttpResponse getPlacedOrderItemHttpResponse(
	...
	public static class Builder {
		...
		public PlacedOrderItemResource build() {
			return new PlacedOrderItemResourceImpl(this);
		}
	...
	public static class PlacedOrderItemResourceImpl
		...
		public PlacedOrderItem getPlacedOrderItem(Long placedOrderItemId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderItemHttpResponse(placedOrderItemId);
		...
		private PlacedOrderItemResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PlacedOrderItemResource.class.getName());
