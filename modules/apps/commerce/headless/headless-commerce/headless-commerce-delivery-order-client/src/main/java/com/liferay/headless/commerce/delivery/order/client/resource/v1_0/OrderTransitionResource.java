 ...
 */
@Generated("")
public interface OrderTransitionResource {
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderOrderTransitionsPageHttpResponse(Long placedOrderId)
		throws Exception;

	public void postPlacedOrderOrderTransitionsPageExportBatch(
			Long placedOrderId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postPlacedOrderOrderTransitionsPageExportBatchHttpResponse(
				Long placedOrderId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postPlacedOrderOrderTransitionHttpResponse(
			Long placedOrderId, OrderTransition orderTransition)
		throws Exception;
	...
	public static class Builder {
		...
		public OrderTransitionResource build() {
			return new OrderTransitionResourceImpl(this);
		}
	...
	public static class OrderTransitionResourceImpl
		implements OrderTransitionResource {
		...
		public Page<OrderTransition> getPlacedOrderOrderTransitionsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderOrderTransitionsPageHttpResponse(placedOrderId);
			...
			try {
				return Page.of(content, OrderTransitionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
				getPlacedOrderOrderTransitionsPageHttpResponse(
					Long placedOrderId)
			throws Exception {
		...
		public OrderTransition postPlacedOrderOrderTransition(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPlacedOrderOrderTransitionHttpResponse(
			...
			try {
				return OrderTransitionSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(orderTransition.toString(), "application/json");
		...
		private OrderTransitionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderTransitionResource.class.getName());
