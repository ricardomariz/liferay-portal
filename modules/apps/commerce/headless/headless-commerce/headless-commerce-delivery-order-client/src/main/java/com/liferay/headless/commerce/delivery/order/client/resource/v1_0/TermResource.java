...
public interface TermResource {
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderByExternalReferenceCodeDeliveryTermHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderByExternalReferenceCodePaymentTermHttpResponse(
				String externalReferenceCode)
		throws Exception;

	public Term getPlacedOrderDeliveryTerm(Long placedOrderId) throws Exception;

	public HttpInvoker.HttpResponse getPlacedOrderDeliveryTermHttpResponse(
			Long placedOrderId)
		throws Exception;

	public Term getPlacedOrderPaymentTerm(Long placedOrderId) throws Exception;

	public HttpInvoker.HttpResponse getPlacedOrderPaymentTermHttpResponse(
			Long placedOrderId)
		throws Exception;
	...
	public static class TermResourceImpl implements TermResource {
		...
		public Term getPlacedOrderDeliveryTerm(Long placedOrderId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderDeliveryTermHttpResponse(placedOrderId);
		...
		public Term getPlacedOrderPaymentTerm(Long placedOrderId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderPaymentTermHttpResponse(placedOrderId);
