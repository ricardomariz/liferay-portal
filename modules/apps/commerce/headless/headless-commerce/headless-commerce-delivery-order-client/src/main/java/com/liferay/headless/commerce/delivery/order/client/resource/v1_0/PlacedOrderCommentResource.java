...
public interface PlacedOrderCommentResource {
	...
	public HttpInvoker.HttpResponse getPlacedOrderCommentHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getPlacedOrderPlacedOrderCommentsPageHttpResponse(
				Long placedOrderId, Pagination pagination)
		throws Exception;

	public void postPlacedOrderPlacedOrderCommentsPageExportBatch(
			Long placedOrderId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postPlacedOrderPlacedOrderCommentsPageExportBatchHttpResponse(
				Long placedOrderId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public PlacedOrderCommentResource build() {
			return new PlacedOrderCommentResourceImpl(this);
		}
	...
	public static class PlacedOrderCommentResourceImpl
		...
		public PlacedOrderComment getPlacedOrderComment(
				Long placedOrderCommentId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderCommentHttpResponse(placedOrderCommentId);
		...
		public HttpInvoker.HttpResponse getPlacedOrderCommentHttpResponse(
			...
			httpInvoker.path("placedOrderCommentId", placedOrderCommentId);
		...
		private PlacedOrderCommentResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PlacedOrderCommentResource.class.getName());
