...
public abstract class BasePaymentMethodGroupRelTermResourceImpl
	implements EntityModelResource, PaymentMethodGroupRelTermResource,
			   VulcanBatchEngineTaskItemDelegate<PaymentMethodGroupRelTerm> {
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/payment-method-group-rel-terms/{paymentMethodGroupRelTermId}"
	)
	...
	public void deletePaymentMethodGroupRelTerm(
			...
			@javax.ws.rs.PathParam("paymentMethodGroupRelTermId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-channel/v1.0/payment-method-group-rel-terms/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/payment-method-group-rel-terms/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/payment-method-group-rels/{id}/payment-method-group-rel-terms"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
