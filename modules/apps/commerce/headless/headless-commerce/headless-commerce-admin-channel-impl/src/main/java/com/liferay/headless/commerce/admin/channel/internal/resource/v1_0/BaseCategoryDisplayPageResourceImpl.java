...
public abstract class BaseCategoryDisplayPageResourceImpl
	implements CategoryDisplayPageResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<CategoryDisplayPage>,
			   VulcanCRUDItemDelegate<CategoryDisplayPage> {
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/category-display-pages/{id}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteCategoryDisplayPage(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-channel/v1.0/category-display-pages/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/category-display-pages/batch")
	...
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public CategoryDisplayPage getCategoryDisplayPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull @javax.ws.rs.PathParam("id")
			Long id)
		throws Exception {
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/channels/by-externalReferenceCode/{externalReferenceCode}/category-display-pages"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{id}/category-display-pages")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public void create(
			Collection<CategoryDisplayPage> categoryDisplayPages,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<CategoryDisplayPage, CategoryDisplayPage, Exception>
			categoryDisplayPageUnsafeFunction = null;
		...
		if (categoryDisplayPageUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for CategoryDisplayPage");
		}
	...
	@Override
	public Page<CategoryDisplayPage> read(
	...
	@Override
	public CategoryDisplayPage getItem(Long id) throws Exception {
		return getCategoryDisplayPage(id);
	}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<CategoryDisplayPage>,
			 UnsafeFunction
				 <CategoryDisplayPage, CategoryDisplayPage, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<CategoryDisplayPage>,
			 UnsafeConsumer<CategoryDisplayPage, Exception>, Exception>
