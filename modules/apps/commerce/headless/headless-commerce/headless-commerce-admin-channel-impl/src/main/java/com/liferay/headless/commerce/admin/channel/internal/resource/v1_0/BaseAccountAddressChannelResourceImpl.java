...
public abstract class BaseAccountAddressChannelResourceImpl
	implements AccountAddressChannelResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<AccountAddressChannel> {
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/account-address-channels/{accountAddressChannelId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteAccountAddressChannel(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("accountAddressChannelId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-channel/v1.0/account-address-channels/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/account-address-channels/batch")
	...
	public Response deleteAccountAddressChannelBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				AccountAddressChannel.class.getName(), callbackURL, object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/account-addresses/{addressId}/account-address-channels")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<AccountAddressChannel>
	...
	public void create(
			Collection<AccountAddressChannel> accountAddressChannels,
	...
	@Override
	public Page<AccountAddressChannel> read(
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<AccountAddressChannel>,
			 UnsafeFunction
				 <AccountAddressChannel, AccountAddressChannel, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<AccountAddressChannel>,
			 UnsafeConsumer<AccountAddressChannel, Exception>, Exception>
