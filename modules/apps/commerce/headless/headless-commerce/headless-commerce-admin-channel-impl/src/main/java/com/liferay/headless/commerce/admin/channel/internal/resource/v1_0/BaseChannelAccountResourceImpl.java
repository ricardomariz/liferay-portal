...
public abstract class BaseChannelAccountResourceImpl
	implements ChannelAccountResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<ChannelAccount> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "ChannelAccount")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/channel-accounts/{channelAccountId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteChannelAccount(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("channelAccountId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-channel/v1.0/channel-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/channel-accounts/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{id}/channel-accounts")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public void create(
			Collection<ChannelAccount> channelAccounts,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<ChannelAccount, ChannelAccount, Exception>
			channelAccountUnsafeFunction = null;
		...
		if (channelAccountUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ChannelAccount");
		}
	...
	@Override
	public Page<ChannelAccount> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ChannelAccount>,
			 UnsafeConsumer<ChannelAccount, Exception>, Exception>
	...
	protected UnsafeBiConsumer
		<Collection<ChannelAccount>,
		 UnsafeFunction<ChannelAccount, ChannelAccount, Exception>, Exception>
			contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<ChannelAccount>, UnsafeConsumer<ChannelAccount, Exception>,
