...
public abstract class BaseProductDisplayPageResourceImpl
	implements EntityModelResource, ProductDisplayPageResource,
			   ...
			   VulcanCRUDItemDelegate<ProductDisplayPage> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-channel/v1.0/product-display-pages/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public void create(
			Collection<ProductDisplayPage> productDisplayPages,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<ProductDisplayPage, ProductDisplayPage, Exception>
			productDisplayPageUnsafeFunction = null;
		...
		if (productDisplayPageUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ProductDisplayPage");
		}
	...
	@Override
	public Page<ProductDisplayPage> read(
	...
	@Override
	public ProductDisplayPage getItem(Long id) throws Exception {
		return getProductDisplayPage(id);
	}
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ProductDisplayPage>,
			 UnsafeConsumer<ProductDisplayPage, Exception>, Exception>
