...
public abstract class BaseOptionValueResourceImpl
	implements EntityModelResource, OptionValueResource,
			   ...
			   VulcanCRUDItemDelegate<OptionValue> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/optionValues/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public void create(
			Collection<OptionValue> optionValues,
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			if (parameters.containsKey("externalReferenceCode")) {
				optionValueUnsafeFunction =
					optionValue -> postOptionByExternalReferenceCodeOptionValue(
	...
	@Override
	public OptionValue getItem(Long id) throws Exception {
