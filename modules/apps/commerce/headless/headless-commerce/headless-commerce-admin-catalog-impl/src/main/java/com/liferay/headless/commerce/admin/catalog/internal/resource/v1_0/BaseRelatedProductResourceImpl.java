...
public abstract class BaseRelatedProductResourceImpl
	implements EntityModelResource, RelatedProductResource,
			   ...
			   VulcanCRUDItemDelegate<RelatedProduct> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/relatedProducts'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "RelatedProduct")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/relatedProducts' -d $'{"priority": ___, "productExternalReferenceCode": ___, "productId": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/products/{id}/relatedProducts")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/relatedProducts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/products/relatedProducts/batch")
	@javax.ws.rs.POST
	...
	public Response postProductIdRelatedProductBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				RelatedProduct.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/relatedProducts/{id}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/relatedProducts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/relatedProducts/batch")
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response deleteRelatedProductBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				RelatedProduct.class.getName(), callbackURL, object)
		).build();
	}
	...
	public void create(
			Collection<RelatedProduct> relatedProducts,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<RelatedProduct, RelatedProduct, Exception>
			relatedProductUnsafeFunction = null;
		...
		if (relatedProductUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for RelatedProduct");
		}
	...
	@Override
	public RelatedProduct getItem(Long id) throws Exception {
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<RelatedProduct>,
			 UnsafeConsumer<RelatedProduct, Exception>, Exception>
	...
	protected UnsafeBiConsumer
		<Collection<RelatedProduct>,
		 UnsafeFunction<RelatedProduct, RelatedProduct, Exception>, Exception>
			contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<RelatedProduct>, UnsafeConsumer<RelatedProduct, Exception>,
