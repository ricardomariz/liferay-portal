...
public abstract class BaseProductConfigurationListOrderTypeResourceImpl
	implements EntityModelResource, ProductConfigurationListOrderTypeResource,
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ProductConfigurationListOrderType"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/product-configuration-list-order-types/{productConfigurationListOrderTypeId}"
	)
	...
	public void deleteProductConfigurationListOrderType(
			...
			@javax.ws.rs.PathParam("productConfigurationListOrderTypeId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-list-order-types/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/product-configuration-list-order-types/batch")
	...
	public Response deleteProductConfigurationListOrderTypeBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				ProductConfigurationListOrderType.class.getName(), callbackURL,
				object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/by-externalReferenceCode/{externalReferenceCode}/product-configuration-list-order-types"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/{id}/product-configuration-list-order-types"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<ProductConfigurationListOrderType>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-lists/product-configuration-list-order-types/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path(
		"/product-configuration-lists/product-configuration-list-order-types/batch"
	)
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<ProductConfigurationListOrderType>
		...
		UnsafeFunction
			<ProductConfigurationListOrderType,
			 ProductConfigurationListOrderType, Exception>
				productConfigurationListOrderTypeUnsafeFunction = null;
		...
		if (productConfigurationListOrderTypeUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ProductConfigurationListOrderType");
		}
		...
		if (contextBatchUnsafeBiConsumer != null) {
			...
			contextBatchUnsafeConsumer.accept(
				productConfigurationListOrderTypes,
				productConfigurationListOrderTypeUnsafeFunction::apply);
		}
		else {
	...
	@Override
	public Page<ProductConfigurationListOrderType> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ProductConfigurationListOrderType>,
			 UnsafeConsumer<ProductConfigurationListOrderType, Exception>,
