...
public abstract class BaseProductConfigurationListAccountResourceImpl
	implements EntityModelResource, ProductConfigurationListAccountResource,
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
				...
				name = "productConfigurationListAccountId"
			)
		}
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ProductConfigurationListAccount"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/product-configuration-list-accounts/{productConfigurationListAccountId}"
	)
	...
	public void deleteProductConfigurationListAccount(
			...
			@javax.ws.rs.PathParam("productConfigurationListAccountId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-list-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/product-configuration-list-accounts/batch")
	...
	public Response deleteProductConfigurationListAccountBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				ProductConfigurationListAccount.class.getName(), callbackURL,
				object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/by-externalReferenceCode/{externalReferenceCode}/product-configuration-list-accounts"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/{id}/product-configuration-list-accounts"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<ProductConfigurationListAccount>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-lists/product-configuration-list-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path(
		"/product-configuration-lists/product-configuration-list-accounts/batch"
	)
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<ProductConfigurationListAccount>
		...
		UnsafeFunction
			<ProductConfigurationListAccount, ProductConfigurationListAccount,
			 Exception> productConfigurationListAccountUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			if (parameters.containsKey("externalReferenceCode")) {
				productConfigurationListAccountUnsafeFunction =
					productConfigurationListAccount ->
						postProductConfigurationListByExternalReferenceCodeProductConfigurationListAccount(
		...
		if (productConfigurationListAccountUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ProductConfigurationListAccount");
		}
		...
		if (contextBatchUnsafeBiConsumer != null) {
			...
			contextBatchUnsafeConsumer.accept(
				productConfigurationListAccounts,
				productConfigurationListAccountUnsafeFunction::apply);
		}
		else {
	...
	@Override
	public Page<ProductConfigurationListAccount> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ProductConfigurationListAccount>,
			 UnsafeConsumer<ProductConfigurationListAccount, Exception>,
	...
	protected UnsafeBiConsumer
		<Collection<ProductConfigurationListAccount>,
		 UnsafeConsumer<ProductConfigurationListAccount, Exception>, Exception>
