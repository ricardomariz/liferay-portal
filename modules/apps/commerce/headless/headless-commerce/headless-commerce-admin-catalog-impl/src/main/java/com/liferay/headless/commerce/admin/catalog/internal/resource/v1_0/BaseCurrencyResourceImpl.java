...
public abstract class BaseCurrencyResourceImpl
	implements CurrencyResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<Currency>,
			   VulcanCRUDItemDelegate<Currency> {
	...
	public Response postCurrenciesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				Currency.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
	...
	@Override
	public Page<Currency> read(
			Filter filter, Pagination pagination, Sort[] sorts,
			Map<String, Serializable> parameters, String search)
		throws Exception {

		return getCurrenciesPage(search, filter, pagination, sorts);
	}
	...
	@Override
	public Currency getItem(Long id) throws Exception {
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<Currency>,
			 UnsafeFunction<Currency, Currency, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<Currency>, UnsafeConsumer<Currency, Exception>,
	...
	protected UnsafeBiConsumer
		<Collection<Currency>, UnsafeFunction<Currency, Currency, Exception>,
		 Exception> contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<Currency>, UnsafeConsumer<Currency, Exception>, Exception>
