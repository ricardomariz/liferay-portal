...
public abstract class BaseProductGroupResourceImpl
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/product-groups")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-groups/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/product-groups/export-batch")
	@javax.ws.rs.POST
	...
	public Response postProductGroupsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				ProductGroup.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/product-groups/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postProductGroupBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				ProductGroup.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/product-groups/{id}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public Response deleteProductGroupBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				ProductGroup.class.getName(), callbackURL, object)
		).build();
	}
	...
	public void create(
			Collection<ProductGroup> productGroups,
	...
	public Page<ProductGroup> read(
		...
		return getProductGroupsPage(search, filter, pagination, sorts);
	}
