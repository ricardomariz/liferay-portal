...
public abstract class BaseProductConfigurationListChannelResourceImpl
	implements EntityModelResource, ProductConfigurationListChannelResource,
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
				...
				name = "productConfigurationListChannelId"
			)
		}
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ProductConfigurationListChannel"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/product-configuration-list-channels/{productConfigurationListChannelId}"
	)
	...
	public void deleteProductConfigurationListChannel(
			...
			@javax.ws.rs.PathParam("productConfigurationListChannelId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-list-channels/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/product-configuration-list-channels/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/by-externalReferenceCode/{externalReferenceCode}/product-configuration-list-channels"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/{id}/product-configuration-list-channels"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<ProductConfigurationListChannel>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-lists/product-configuration-list-channels/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path(
		"/product-configuration-lists/product-configuration-list-channels/batch"
	)
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<ProductConfigurationListChannel>
		...
		UnsafeFunction
			<ProductConfigurationListChannel, ProductConfigurationListChannel,
			 Exception> productConfigurationListChannelUnsafeFunction = null;
		...
		if (productConfigurationListChannelUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ProductConfigurationListChannel");
		}
	...
	@Override
	public Page<ProductConfigurationListChannel> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ProductConfigurationListChannel>,
			 UnsafeConsumer<ProductConfigurationListChannel, Exception>,
	...
	protected UnsafeBiConsumer
		<Collection<ProductConfigurationListChannel>,
		 UnsafeConsumer<ProductConfigurationListChannel, Exception>, Exception>
