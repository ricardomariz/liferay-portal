...
public abstract class BaseGroupedProductResourceImpl
	implements EntityModelResource, GroupedProductResource,
			   VulcanBatchEngineTaskItemDelegate<GroupedProduct> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/grouped-products/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public void create(
			Collection<GroupedProduct> groupedProducts,
	...
	@Override
	public Page<GroupedProduct> read(
