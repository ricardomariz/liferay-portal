...
public abstract class BaseOptionCategoryResourceImpl
	implements EntityModelResource, OptionCategoryResource,
			   ...
			   VulcanCRUDItemDelegate<OptionCategory> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/optionCategories/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public Response postOptionCategoriesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				OptionCategory.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public Response postOptionCategoryBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				OptionCategory.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public Response deleteOptionCategoryBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				OptionCategory.class.getName(), callbackURL, object)
		).build();
	}
	...
	public void create(
			Collection<OptionCategory> optionCategories,
	...
	@Override
	public OptionCategory getItem(Long id) throws Exception {
		return getOptionCategory(id);
	}
