...
public abstract class BaseProductConfigurationListAccountGroupResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ProductConfigurationListAccountGroup"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/product-configuration-list-account-groups/{productConfigurationListAccountGroupId}"
	)
	...
	public void deleteProductConfigurationListAccountGroup(
			...
			@javax.ws.rs.PathParam("productConfigurationListAccountGroupId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-list-account-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/product-configuration-list-account-groups/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/by-externalReferenceCode/{externalReferenceCode}/product-configuration-list-account-groups"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/product-configuration-lists/{id}/product-configuration-list-account-groups"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<ProductConfigurationListAccountGroup>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/product-configuration-lists/product-configuration-list-account-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path(
		"/product-configuration-lists/product-configuration-list-account-groups/batch"
	)
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<ProductConfigurationListAccountGroup>
		...
		UnsafeFunction
			<ProductConfigurationListAccountGroup,
			 ProductConfigurationListAccountGroup, Exception>
				productConfigurationListAccountGroupUnsafeFunction = null;
		...
		if (productConfigurationListAccountGroupUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ProductConfigurationListAccountGroup");
		}
	...
	@Override
	public Page<ProductConfigurationListAccountGroup> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ProductConfigurationListAccountGroup>,
			 UnsafeConsumer<ProductConfigurationListAccountGroup, Exception>,
