...
public abstract class BaseProductAccountGroupResourceImpl
	implements EntityModelResource, ProductAccountGroupResource,
			   ...
			   VulcanCRUDItemDelegate<ProductAccountGroup> {
	...
	public void create(
			Collection<ProductAccountGroup> productAccountGroups,
	...
	@Override
	public ProductAccountGroup getItem(Long id) throws Exception {
		return getProductAccountGroup(id);
	}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<ProductAccountGroup>,
			 UnsafeFunction
				 <ProductAccountGroup, ProductAccountGroup, Exception>,
