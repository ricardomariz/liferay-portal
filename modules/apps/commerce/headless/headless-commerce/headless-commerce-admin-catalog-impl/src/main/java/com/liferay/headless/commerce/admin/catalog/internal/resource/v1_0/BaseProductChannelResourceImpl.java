...
public abstract class BaseProductChannelResourceImpl
	implements EntityModelResource, ProductChannelResource,
			   ...
			   VulcanCRUDItemDelegate<ProductChannel> {
	...
	public void create(
			Collection<ProductChannel> productChannels,
	...
	@Override
	public ProductChannel getItem(Long id) throws Exception {
		return getProductChannel(id);
	}
	...
	protected UnsafeBiConsumer
		<Collection<ProductChannel>,
		 UnsafeFunction<ProductChannel, ProductChannel, Exception>, Exception>
			contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<ProductChannel>, UnsafeConsumer<ProductChannel, Exception>,
