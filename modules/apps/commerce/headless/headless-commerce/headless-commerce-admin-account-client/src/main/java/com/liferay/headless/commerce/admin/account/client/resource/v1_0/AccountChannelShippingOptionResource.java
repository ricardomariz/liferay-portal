 ...
 */
@Generated("")
public interface AccountChannelShippingOptionResource {
	...
	public HttpInvoker.HttpResponse
			deleteAccountChannelShippingOptionHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postAccountIdAccountChannelShippingOptionHttpResponse(
				Long id,
				AccountChannelShippingOption accountChannelShippingOption)
		throws Exception;
	...
	public static class Builder {
		...
		public AccountChannelShippingOptionResource build() {
			return new AccountChannelShippingOptionResourceImpl(this);
		}
	...
	public static class AccountChannelShippingOptionResourceImpl
		implements AccountChannelShippingOptionResource {

		public void deleteAccountChannelShippingOption(Long id)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteAccountChannelShippingOptionHttpResponse(id);
		...
		public Page<AccountChannelShippingOption>
			...
			try {
				return Page.of(
					content, AccountChannelShippingOptionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-account/v1.0/accounts/{id}/account-channel-shipping-option");
		...
		private AccountChannelShippingOptionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AccountChannelShippingOptionResource.class.getName());
