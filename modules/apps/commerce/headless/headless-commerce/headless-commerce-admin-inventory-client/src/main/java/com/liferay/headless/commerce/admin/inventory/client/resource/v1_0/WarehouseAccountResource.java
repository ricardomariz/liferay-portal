 ...
 */
@Generated("")
public interface WarehouseAccountResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteWarehouseAccount(Long warehouseAccountId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteWarehouseAccountHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getWarehouseByExternalReferenceCodeWarehouseAccountsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postWarehouseByExternalReferenceCodeWarehouseAccountHttpResponse(
				String externalReferenceCode, WarehouseAccount warehouseAccount)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getWarehouseIdWarehouseAccountsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse postWarehouseIdWarehouseAccountHttpResponse(
			Long id, WarehouseAccount warehouseAccount)
		throws Exception;
	...
	public static class Builder {
		...
		public WarehouseAccountResource build() {
			return new WarehouseAccountResourceImpl(this);
		}
	...
	public static class WarehouseAccountResourceImpl
		implements WarehouseAccountResource {

		public void deleteWarehouseAccount(Long warehouseAccountId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteWarehouseAccountHttpResponse(warehouseAccountId);
		...
		public HttpInvoker.HttpResponse deleteWarehouseAccountHttpResponse(
			...
			httpInvoker.path("warehouseAccountId", warehouseAccountId);
		...
		public Page<WarehouseAccount>
			...
			try {
				return Page.of(content, WarehouseAccountSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public WarehouseAccount
			...
			try {
				return WarehouseAccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(warehouseAccount.toString(), "application/json");
		...
		public WarehouseAccount postWarehouseIdWarehouseAccount(
			...
			HttpInvoker.HttpResponse httpResponse =
				postWarehouseIdWarehouseAccountHttpResponse(
					id, warehouseAccount);
		...
		private WarehouseAccountResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			WarehouseAccountResource.class.getName());
