...
public interface ChannelResource {
	...
	public HttpInvoker.HttpResponse getWarehouseChannelChannelHttpResponse(
	...
	public static class ChannelResourceImpl implements ChannelResource {
		...
		public Channel getWarehouseChannelChannel(Long warehouseChannelId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getWarehouseChannelChannelHttpResponse(warehouseChannelId);
			...
			try {
				return com.liferay.headless.commerce.admin.inventory.client.
					serdes.v1_0.ChannelSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
