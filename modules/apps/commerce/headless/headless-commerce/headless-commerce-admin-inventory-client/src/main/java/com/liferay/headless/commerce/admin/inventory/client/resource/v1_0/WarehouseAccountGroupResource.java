 ...
 */
@Generated("")
public interface WarehouseAccountGroupResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteWarehouseAccountGroup(Long warehouseAccountGroupId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteWarehouseAccountGroupHttpResponse(
			Long warehouseAccountGroupId)
		throws Exception;

	public void deleteWarehouseAccountGroupBatch(
	...
	public HttpInvoker.HttpResponse
			getWarehouseByExternalReferenceCodeWarehouseAccountGroupsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postWarehouseByExternalReferenceCodeWarehouseAccountGroupHttpResponse(
				String externalReferenceCode,
				WarehouseAccountGroup warehouseAccountGroup)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getWarehouseIdWarehouseAccountGroupsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse
			postWarehouseIdWarehouseAccountGroupHttpResponse(
				Long id, WarehouseAccountGroup warehouseAccountGroup)
		throws Exception;

	public void postWarehouseIdWarehouseAccountGroupBatch(
			String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse
			postWarehouseIdWarehouseAccountGroupBatchHttpResponse(
				String callbackURL, Object object)
		throws Exception;
	...
	public static class Builder {
		...
		public WarehouseAccountGroupResource build() {
			return new WarehouseAccountGroupResourceImpl(this);
		}
	...
	public static class WarehouseAccountGroupResourceImpl
		implements WarehouseAccountGroupResource {
		...
		public HttpInvoker.HttpResponse deleteWarehouseAccountGroupHttpResponse(
			...
			httpInvoker.path(
				"warehouseAccountGroupId", warehouseAccountGroupId);
		...
		public Page<WarehouseAccountGroup>
			...
			try {
				return Page.of(content, WarehouseAccountGroupSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public WarehouseAccountGroup
			...
			try {
				return WarehouseAccountGroupSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				warehouseAccountGroup.toString(), "application/json");
		...
		private WarehouseAccountGroupResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			WarehouseAccountGroupResource.class.getName());
