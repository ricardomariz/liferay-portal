...
public interface AccountResource {
	...
	public Account getWarehouseAccountAccount(Long warehouseAccountId)
		throws Exception;

	public HttpInvoker.HttpResponse getWarehouseAccountAccountHttpResponse(
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Account getWarehouseAccountAccount(Long warehouseAccountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getWarehouseAccountAccountHttpResponse(warehouseAccountId);
			...
			try {
				return com.liferay.headless.commerce.admin.inventory.client.
