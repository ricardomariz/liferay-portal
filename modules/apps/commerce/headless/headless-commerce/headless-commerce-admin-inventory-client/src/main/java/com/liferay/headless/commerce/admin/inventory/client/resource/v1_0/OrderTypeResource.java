...
public interface OrderTypeResource {
	...
	public HttpInvoker.HttpResponse getWarehouseOrderTypeOrderTypeHttpResponse(
	...
	public static class OrderTypeResourceImpl implements OrderTypeResource {
		...
		public OrderType getWarehouseOrderTypeOrderType(
				Long warehouseOrderTypeId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getWarehouseOrderTypeOrderTypeHttpResponse(
			...
			try {
				return com.liferay.headless.commerce.admin.inventory.client.
					serdes.v1_0.OrderTypeSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
