 ...
 */
@Generated("")
public interface OrderRuleAccountResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteOrderRuleAccount(Long orderRuleAccountId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteOrderRuleAccountHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getOrderRuleByExternalReferenceCodeOrderRuleAccountsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderRuleByExternalReferenceCodeOrderRuleAccountHttpResponse(
				String externalReferenceCode, OrderRuleAccount orderRuleAccount)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrderRuleIdOrderRuleAccountsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse postOrderRuleIdOrderRuleAccountHttpResponse(
			Long id, OrderRuleAccount orderRuleAccount)
		throws Exception;
	...
	public static class Builder {
		...
		public OrderRuleAccountResource build() {
	...
	public static class OrderRuleAccountResourceImpl
		implements OrderRuleAccountResource {

		public void deleteOrderRuleAccount(Long orderRuleAccountId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteOrderRuleAccountHttpResponse(orderRuleAccountId);
		...
		public Page<OrderRuleAccount>
			...
			try {
				return Page.of(content, OrderRuleAccountSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public OrderRuleAccount
			...
			try {
				return OrderRuleAccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(orderRuleAccount.toString(), "application/json");
		...
		public OrderRuleAccount postOrderRuleIdOrderRuleAccount(
			...
			HttpInvoker.HttpResponse httpResponse =
				postOrderRuleIdOrderRuleAccountHttpResponse(
					id, orderRuleAccount);
		...
		private OrderRuleAccountResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderRuleAccountResource.class.getName());
