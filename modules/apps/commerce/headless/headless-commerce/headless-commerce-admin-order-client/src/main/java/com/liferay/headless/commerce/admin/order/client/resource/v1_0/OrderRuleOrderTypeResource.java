 ...
 */
@Generated("")
public interface OrderRuleOrderTypeResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteOrderRuleOrderType(Long orderRuleOrderTypeId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteOrderRuleOrderTypeHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getOrderRuleByExternalReferenceCodeOrderRuleOrderTypesPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderRuleByExternalReferenceCodeOrderRuleOrderTypeHttpResponse(
				String externalReferenceCode,
				OrderRuleOrderType orderRuleOrderType)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrderRuleIdOrderRuleOrderTypesPageHttpResponse(
				Long id, String search, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderRuleIdOrderRuleOrderTypeHttpResponse(
				Long id, OrderRuleOrderType orderRuleOrderType)
		throws Exception;
	...
	public static class Builder {
		...
		public OrderRuleOrderTypeResource build() {
			return new OrderRuleOrderTypeResourceImpl(this);
		}
	...
	public static class OrderRuleOrderTypeResourceImpl
		implements OrderRuleOrderTypeResource {

		public void deleteOrderRuleOrderType(Long orderRuleOrderTypeId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteOrderRuleOrderTypeHttpResponse(orderRuleOrderTypeId);
		...
		public Page<OrderRuleOrderType>
			...
			try {
				return Page.of(content, OrderRuleOrderTypeSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public OrderRuleOrderType
			...
			try {
				return OrderRuleOrderTypeSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(orderRuleOrderType.toString(), "application/json");
		...
		private OrderRuleOrderTypeResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderRuleOrderTypeResource.class.getName());
