...
public interface TermResource {
	...
	public HttpInvoker.HttpResponse getTermsPageHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;

	public void postTermsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postTermsPageExportBatchHttpResponse(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			deleteTermByExternalReferenceCodeHttpResponse(
	...
	public HttpInvoker.HttpResponse getTermByExternalReferenceCodeHttpResponse(
			String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchTermByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Term term)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putTermByExternalReferenceCodeHttpResponse(
			String externalReferenceCode, Term term)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getTermHttpResponse(Long id)
		throws Exception;

	public Term patchTerm(Long id, Term term) throws Exception;

	public HttpInvoker.HttpResponse patchTermHttpResponse(Long id, Term term)
		throws Exception;
	...
	public static class TermResourceImpl implements TermResource {
		...
		public Page<Term> getTermsPage(
			...
			HttpInvoker.HttpResponse httpResponse = getTermsPageHttpResponse(
			...
			try {
				return Page.of(content, TermSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public void postTermsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postTermsPageExportBatchHttpResponse(
		...
		public Term postTerm(Term term) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postTermHttpResponse(term);
			...
			try {
				return TermSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postTermHttpResponse(Term term)
			...
			httpInvoker.body(term.toString(), "application/json");
		...
		public Term getTermByExternalReferenceCode(String externalReferenceCode)
			...
			HttpInvoker.HttpResponse httpResponse =
				getTermByExternalReferenceCodeHttpResponse(
					externalReferenceCode);
		...
		public Term putTermByExternalReferenceCode(
			...
			HttpInvoker.HttpResponse httpResponse =
				putTermByExternalReferenceCodeHttpResponse(
					externalReferenceCode, term);
		...
		public void deleteTerm(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteTermHttpResponse(id);
		...
		public Term getTerm(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getTermHttpResponse(id);
		...
		public Term patchTerm(Long id, Term term) throws Exception {
			HttpInvoker.HttpResponse httpResponse = patchTermHttpResponse(
				id, term);
		...
		public HttpInvoker.HttpResponse patchTermHttpResponse(
				Long id, Term term)
			throws Exception {
