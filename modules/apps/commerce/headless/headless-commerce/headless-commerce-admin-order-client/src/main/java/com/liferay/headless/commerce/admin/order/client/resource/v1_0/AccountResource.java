...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse getOrderRuleAccountAccountHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getOrderByExternalReferenceCodeAccountHttpResponse(
				String externalReferenceCode)
		throws Exception;

	public Account getOrderIdAccount(Long id) throws Exception;

	public HttpInvoker.HttpResponse getOrderIdAccountHttpResponse(Long id)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Account getOrderRuleAccountAccount(Long orderRuleAccountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderRuleAccountAccountHttpResponse(orderRuleAccountId);
			...
			try {
				return com.liferay.headless.commerce.admin.order.client.serdes.
					v1_0.AccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Account getOrderIdAccount(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getOrderIdAccountHttpResponse(id);
