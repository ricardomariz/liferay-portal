...
public interface OrderTypeChannelResource {
	...
	public HttpInvoker.HttpResponse deleteOrderTypeChannelHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getOrderTypeByExternalReferenceCodeOrderTypeChannelsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderTypeByExternalReferenceCodeOrderTypeChannelHttpResponse(
				String externalReferenceCode, OrderTypeChannel orderTypeChannel)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrderTypeIdOrderTypeChannelsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse postOrderTypeIdOrderTypeChannelHttpResponse(
			Long id, OrderTypeChannel orderTypeChannel)
		throws Exception;
	...
	public static class Builder {
		...
		public OrderTypeChannelResource build() {
			return new OrderTypeChannelResourceImpl(this);
		}
	...
	public static class OrderTypeChannelResourceImpl
		implements OrderTypeChannelResource {

		public void deleteOrderTypeChannel(Long orderTypeChannelId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteOrderTypeChannelHttpResponse(orderTypeChannelId);
		...
		public Page<OrderTypeChannel>
			...
			try {
				return Page.of(content, OrderTypeChannelSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public OrderTypeChannel
			...
			try {
				return OrderTypeChannelSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(orderTypeChannel.toString(), "application/json");
		...
		public OrderTypeChannel postOrderTypeIdOrderTypeChannel(
			...
			HttpInvoker.HttpResponse httpResponse =
				postOrderTypeIdOrderTypeChannelHttpResponse(
					id, orderTypeChannel);
		...
		private OrderTypeChannelResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderTypeChannelResource.class.getName());
