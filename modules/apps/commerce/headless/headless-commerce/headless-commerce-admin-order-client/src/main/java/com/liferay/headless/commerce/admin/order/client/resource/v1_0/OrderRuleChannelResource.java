 ...
 */
@Generated("")
public interface OrderRuleChannelResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteOrderRuleChannel(Long orderRuleChannelId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteOrderRuleChannelHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getOrderRuleByExternalReferenceCodeOrderRuleChannelsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderRuleByExternalReferenceCodeOrderRuleChannelHttpResponse(
				String externalReferenceCode, OrderRuleChannel orderRuleChannel)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrderRuleIdOrderRuleChannelsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse postOrderRuleIdOrderRuleChannelHttpResponse(
			Long id, OrderRuleChannel orderRuleChannel)
		throws Exception;
	...
	public static class Builder {
		...
		public OrderRuleChannelResource build() {
			return new OrderRuleChannelResourceImpl(this);
		}
	...
	public static class OrderRuleChannelResourceImpl
		implements OrderRuleChannelResource {

		public void deleteOrderRuleChannel(Long orderRuleChannelId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteOrderRuleChannelHttpResponse(orderRuleChannelId);
		...
		public HttpInvoker.HttpResponse deleteOrderRuleChannelHttpResponse(
			...
			httpInvoker.path("orderRuleChannelId", orderRuleChannelId);
		...
		public Page<OrderRuleChannel>
			...
			try {
				return Page.of(content, OrderRuleChannelSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public OrderRuleChannel
			...
			try {
				return OrderRuleChannelSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(orderRuleChannel.toString(), "application/json");
		...
		public OrderRuleChannel postOrderRuleIdOrderRuleChannel(
			...
			HttpInvoker.HttpResponse httpResponse =
				postOrderRuleIdOrderRuleChannelHttpResponse(
					id, orderRuleChannel);
		...
		private OrderRuleChannelResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderRuleChannelResource.class.getName());
