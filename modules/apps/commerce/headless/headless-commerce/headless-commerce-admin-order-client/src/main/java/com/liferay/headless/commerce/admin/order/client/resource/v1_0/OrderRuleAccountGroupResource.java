 ...
 */
@Generated("")
public interface OrderRuleAccountGroupResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteOrderRuleAccountGroup(Long orderRuleAccountGroupId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteOrderRuleAccountGroupHttpResponse(
			Long orderRuleAccountGroupId)
		throws Exception;

	public void deleteOrderRuleAccountGroupBatch(
	...
	public HttpInvoker.HttpResponse
			getOrderRuleByExternalReferenceCodeOrderRuleAccountGroupsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderRuleByExternalReferenceCodeOrderRuleAccountGroupHttpResponse(
				String externalReferenceCode,
				OrderRuleAccountGroup orderRuleAccountGroup)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrderRuleIdOrderRuleAccountGroupsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse
			postOrderRuleIdOrderRuleAccountGroupHttpResponse(
				Long id, OrderRuleAccountGroup orderRuleAccountGroup)
		throws Exception;
	...
	public static class Builder {
		...
		public OrderRuleAccountGroupResource build() {
			return new OrderRuleAccountGroupResourceImpl(this);
		}
	...
	public static class OrderRuleAccountGroupResourceImpl
		implements OrderRuleAccountGroupResource {
		...
		public Page<OrderRuleAccountGroup>
			...
			try {
				return Page.of(content, OrderRuleAccountGroupSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public OrderRuleAccountGroup
			...
			try {
				return OrderRuleAccountGroupSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				orderRuleAccountGroup.toString(), "application/json");
		...
		private OrderRuleAccountGroupResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderRuleAccountGroupResource.class.getName());
