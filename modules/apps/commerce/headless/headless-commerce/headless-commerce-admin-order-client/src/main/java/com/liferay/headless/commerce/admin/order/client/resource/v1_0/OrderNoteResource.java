...
public interface OrderNoteResource {
	...
	public void deleteOrderNoteByExternalReferenceCode(
	...
	public HttpInvoker.HttpResponse
			getOrderNoteByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;

	public void patchOrderNoteByExternalReferenceCode(
			String externalReferenceCode, OrderNote orderNote)
		throws Exception;

	public HttpInvoker.HttpResponse
			patchOrderNoteByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, OrderNote orderNote)
		throws Exception;

	public void deleteOrderNote(Long id) throws Exception;
	...
	public HttpInvoker.HttpResponse getOrderNoteHttpResponse(Long id)
		throws Exception;

	public void patchOrderNote(Long id, OrderNote orderNote) throws Exception;

	public HttpInvoker.HttpResponse patchOrderNoteHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getOrderByExternalReferenceCodeOrderNotesPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postOrderByExternalReferenceCodeOrderNoteHttpResponse(
				String externalReferenceCode, OrderNote orderNote)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getOrderIdOrderNotesPageHttpResponse(
			Long id, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postOrderIdOrderNoteHttpResponse(
			Long id, OrderNote orderNote)
		throws Exception;
	...
	public static class OrderNoteResourceImpl implements OrderNoteResource {
		...
		public OrderNote getOrderNoteByExternalReferenceCode(
			...
			try {
				return OrderNoteSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(orderNote.toString(), "application/json");
		...
		public void deleteOrderNote(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteOrderNoteHttpResponse(
				id);
		...
		public OrderNote getOrderNote(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getOrderNoteHttpResponse(
				id);
		...
		public void patchOrderNote(Long id, OrderNote orderNote)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = patchOrderNoteHttpResponse(
				id, orderNote);
		...
		public Page<OrderNote> getOrderByExternalReferenceCodeOrderNotesPage(
			...
			try {
				return Page.of(content, OrderNoteSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<OrderNote> getOrderIdOrderNotesPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderIdOrderNotesPageHttpResponse(id, pagination);
		...
		public OrderNote postOrderIdOrderNote(Long id, OrderNote orderNote)
			...
			HttpInvoker.HttpResponse httpResponse =
				postOrderIdOrderNoteHttpResponse(id, orderNote);
		...
		private OrderNoteResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrderNoteResource.class.getName());
