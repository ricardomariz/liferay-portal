...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse getChannelAccountsPageHttpResponse(
			Long channelId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postChannelAccountHttpResponse(
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Page<Account> getChannelAccountsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelAccountsPageHttpResponse(
		...
		public Account postChannelAccount(Long channelId, Account account)
			...
			HttpInvoker.HttpResponse httpResponse =
				postChannelAccountHttpResponse(channelId, account);
