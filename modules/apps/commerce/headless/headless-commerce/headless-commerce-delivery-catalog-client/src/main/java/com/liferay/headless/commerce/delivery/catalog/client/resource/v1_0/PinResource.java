...
public interface PinResource {
	...
	public HttpInvoker.HttpResponse
			getChannelByExternalReferenceCodeChannelExternalReferenceCodeProductByExternalReferenceCodeProductExternalReferenceCodePinsPageHttpResponse(
				String channelExternalReferenceCode,
				String productExternalReferenceCode, Long accountId,
				String search, Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getChannelProductPinsPageHttpResponse(
			Long channelId, Long productId, Long accountId, String search,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class PinResourceImpl implements PinResource {
		...
		public Page<Pin>
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelByExternalReferenceCodeChannelExternalReferenceCodeProductByExternalReferenceCodeProductExternalReferenceCodePinsPageHttpResponse(
					...
					accountId, search, pagination, sortString);
		...
		public Page<Pin> getChannelProductPinsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelProductPinsPageHttpResponse(
