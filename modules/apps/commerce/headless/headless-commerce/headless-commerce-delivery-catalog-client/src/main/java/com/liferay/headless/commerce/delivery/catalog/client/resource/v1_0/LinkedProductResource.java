...
public interface LinkedProductResource {
	...
	public HttpInvoker.HttpResponse
			getChannelProductLinkedProductsPageHttpResponse(
				Long channelId, Long productId, Long accountId,
				Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public LinkedProductResource build() {
			return new LinkedProductResourceImpl(this);
		}
	...
	public static class LinkedProductResourceImpl
		...
		public Page<LinkedProduct> getChannelProductLinkedProductsPage(
			...
			try {
				return Page.of(content, LinkedProductSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private LinkedProductResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			LinkedProductResource.class.getName());
