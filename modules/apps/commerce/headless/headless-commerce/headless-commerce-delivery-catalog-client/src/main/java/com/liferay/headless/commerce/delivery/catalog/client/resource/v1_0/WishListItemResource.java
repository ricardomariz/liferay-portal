...
public interface WishListItemResource {
	...
	public HttpInvoker.HttpResponse deleteWishListItemHttpResponse(
			Long wishListItemId)
		throws Exception;

	public void deleteWishListItemBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteWishListItemBatchHttpResponse(
	...
	public static class WishListItemResourceImpl
		implements WishListItemResource {

		public void deleteWishListItem(Long wishListItemId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteWishListItemHttpResponse(wishListItemId);
		...
		public HttpInvoker.HttpResponse deleteWishListItemHttpResponse(
			...
			httpInvoker.path("wishListItemId", wishListItemId);
		...
		public void deleteWishListItemBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteWishListItemBatchHttpResponse(callbackURL, object);
		...
		public WishListItem getWishListItem(Long wishListItemId, Long accountId)
			...
			try {
				return WishListItemSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<WishListItem> getWishlistWishListWishListItemsPage(
			...
			try {
				return Page.of(content, WishListItemSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(wishListItem.toString(), "application/json");
		...
		private WishListItemResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			WishListItemResource.class.getName());
