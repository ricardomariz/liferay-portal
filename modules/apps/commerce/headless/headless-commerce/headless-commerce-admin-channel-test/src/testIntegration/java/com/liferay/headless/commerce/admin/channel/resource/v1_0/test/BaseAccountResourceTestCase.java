...
import com.liferay.headless.commerce.admin.channel.client.dto.v1_0.Account;
...
public abstract class BaseAccountResourceTestCase {
	...
	@Test
	public void testGetChannelAccountAccount() throws Exception {
		Account postAccount = testGetChannelAccountAccount_addAccount();

		Account getAccount = accountResource.getChannelAccountAccount(
			testGetChannelAccountAccount_getChannelAccountId());
	...
	protected Account testGraphQLGetChannelAccountAccount_addAccount()
		throws Exception {
