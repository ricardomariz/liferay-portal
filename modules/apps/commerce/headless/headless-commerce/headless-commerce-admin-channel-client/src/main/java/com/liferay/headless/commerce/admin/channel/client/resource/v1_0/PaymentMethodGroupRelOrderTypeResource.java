 ...
 */
@Generated("")
public interface PaymentMethodGroupRelOrderTypeResource {
	...
	public HttpInvoker.HttpResponse
			getPaymentMethodGroupRelIdPaymentMethodGroupRelOrderTypesPageHttpResponse(
				Long id, String search, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postPaymentMethodGroupRelIdPaymentMethodGroupRelOrderTypeHttpResponse(
				Long id,
				PaymentMethodGroupRelOrderType paymentMethodGroupRelOrderType)
		throws Exception;
	...
	public static class Builder {
		...
		public PaymentMethodGroupRelOrderTypeResource build() {
			return new PaymentMethodGroupRelOrderTypeResourceImpl(this);
		}
	...
	public static class PaymentMethodGroupRelOrderTypeResourceImpl
		implements PaymentMethodGroupRelOrderTypeResource {
		...
		public Page<PaymentMethodGroupRelOrderType>
			...
			try {
				return Page.of(
					content, PaymentMethodGroupRelOrderTypeSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public PaymentMethodGroupRelOrderType
			...
			try {
				return PaymentMethodGroupRelOrderTypeSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				paymentMethodGroupRelOrderType.toString(), "application/json");
		...
		private PaymentMethodGroupRelOrderTypeResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PaymentMethodGroupRelOrderTypeResource.class.getName());
