 ...
 */
@Generated("")
public interface DefaultCategoryDisplayPageResource {
	...
	public HttpInvoker.HttpResponse
			postChannelByExternalReferenceCodeDefaultCategoryDisplayPageHttpResponse(
				String externalReferenceCode,
				DefaultCategoryDisplayPage defaultCategoryDisplayPage)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			deleteChannelIdDefaultCategoryDisplayPageHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getChannelIdDefaultCategoryDisplayPageHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postChannelIdDefaultCategoryDisplayPageHttpResponse(
				Long id, DefaultCategoryDisplayPage defaultCategoryDisplayPage)
		throws Exception;
	...
	public static class Builder {
		...
		public DefaultCategoryDisplayPageResource build() {
			return new DefaultCategoryDisplayPageResourceImpl(this);
		}
	...
	public static class DefaultCategoryDisplayPageResourceImpl
		implements DefaultCategoryDisplayPageResource {
		...
		public DefaultCategoryDisplayPage
			...
			try {
				return com.liferay.headless.commerce.admin.channel.client.
					serdes.v1_0.DefaultCategoryDisplayPageSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				defaultCategoryDisplayPage.toString(), "application/json");
		...
		public void deleteChannelIdDefaultCategoryDisplayPage(Long id)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteChannelIdDefaultCategoryDisplayPageHttpResponse(id);
		...
		public DefaultCategoryDisplayPage
				getChannelIdDefaultCategoryDisplayPage(Long id)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getChannelIdDefaultCategoryDisplayPageHttpResponse(id);
		...
		private DefaultCategoryDisplayPageResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DefaultCategoryDisplayPageResource.class.getName());
