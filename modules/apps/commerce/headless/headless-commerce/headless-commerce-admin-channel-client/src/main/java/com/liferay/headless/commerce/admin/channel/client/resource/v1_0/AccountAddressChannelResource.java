...
public interface AccountAddressChannelResource {
	...
	public HttpInvoker.HttpResponse deleteAccountAddressChannelHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getAccountAddressByExternalReferenceCodeAccountAddressChannelsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postAccountAddressByExternalReferenceCodeAccountAddressChannelHttpResponse(
				String externalReferenceCode,
				AccountAddressChannel accountAddressChannel)
		throws Exception;
	...
	public Page<AccountAddressChannel>
			getAccountAddressIdAccountAddressChannelsPage(
				Long addressId, String search, String filterString,
				Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse
			getAccountAddressIdAccountAddressChannelsPageHttpResponse(
				Long addressId, String search, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postAccountAddressIdAccountAddressChannelHttpResponse(
				Long addressId, AccountAddressChannel accountAddressChannel)
		throws Exception;
	...
	public static class Builder {
		...
		public AccountAddressChannelResource build() {
			return new AccountAddressChannelResourceImpl(this);
		}
	...
	public static class AccountAddressChannelResourceImpl
		implements AccountAddressChannelResource {
		...
		public Page<AccountAddressChannel>
			...
			try {
				return Page.of(content, AccountAddressChannelSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public AccountAddressChannel
			...
			try {
				return AccountAddressChannelSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				accountAddressChannel.toString(), "application/json");
		...
		public Page<AccountAddressChannel>
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountAddressIdAccountAddressChannelsPageHttpResponse(
					addressId, search, filterString, pagination, sortString);
		...
		private AccountAddressChannelResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AccountAddressChannelResource.class.getName());
