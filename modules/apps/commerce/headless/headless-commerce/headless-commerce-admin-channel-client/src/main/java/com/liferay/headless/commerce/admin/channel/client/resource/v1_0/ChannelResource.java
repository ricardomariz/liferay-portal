...
public interface ChannelResource {
	...
	public HttpInvoker.HttpResponse getAccountAddressChannelChannelHttpResponse(
	...
	public void postChannelsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postChannelsPageExportBatchHttpResponse(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getChannelByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchChannelByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Channel channel)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putChannelByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Channel channel)
		throws Exception;
	...
	public static class ChannelResourceImpl implements ChannelResource {
		...
		public Channel getAccountAddressChannelChannel(
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountAddressChannelChannelHttpResponse(
		...
		public void postChannelsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postChannelsPageExportBatchHttpResponse(
