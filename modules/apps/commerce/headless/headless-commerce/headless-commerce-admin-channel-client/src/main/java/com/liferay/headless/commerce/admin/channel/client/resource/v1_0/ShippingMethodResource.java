...
public interface ShippingMethodResource {
	...
	public HttpInvoker.HttpResponse getChannelShippingMethodsPageHttpResponse(
			Long channelId, Pagination pagination)
		throws Exception;

	public void postChannelShippingMethodsPageExportBatch(
			Long channelId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postChannelShippingMethodsPageExportBatchHttpResponse(
				Long channelId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class ShippingMethodResourceImpl
		...
		public Page<ShippingMethod> getChannelShippingMethodsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelShippingMethodsPageHttpResponse(
					channelId, pagination);
