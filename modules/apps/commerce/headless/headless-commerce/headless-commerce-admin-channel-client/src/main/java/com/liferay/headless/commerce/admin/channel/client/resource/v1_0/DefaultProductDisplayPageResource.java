 ...
 */
@Generated("")
public interface DefaultProductDisplayPageResource {
	...
	public HttpInvoker.HttpResponse
			postChannelByExternalReferenceCodeDefaultProductDisplayPageHttpResponse(
				String externalReferenceCode,
				DefaultProductDisplayPage defaultProductDisplayPage)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			deleteChannelIdDefaultProductDisplayPageHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getChannelIdDefaultProductDisplayPageHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postChannelIdDefaultProductDisplayPageHttpResponse(
				Long id, DefaultProductDisplayPage defaultProductDisplayPage)
		throws Exception;
	...
	public static class Builder {
		...
		public DefaultProductDisplayPageResource build() {
			return new DefaultProductDisplayPageResourceImpl(this);
		}
	...
	public static class DefaultProductDisplayPageResourceImpl
		implements DefaultProductDisplayPageResource {
		...
		public DefaultProductDisplayPage
			...
			try {
				return com.liferay.headless.commerce.admin.channel.client.
					serdes.v1_0.DefaultProductDisplayPageSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				defaultProductDisplayPage.toString(), "application/json");
		...
		public void deleteChannelIdDefaultProductDisplayPage(Long id)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteChannelIdDefaultProductDisplayPageHttpResponse(id);
		...
		public DefaultProductDisplayPage getChannelIdDefaultProductDisplayPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelIdDefaultProductDisplayPageHttpResponse(id);
		...
		private DefaultProductDisplayPageResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DefaultProductDisplayPageResource.class.getName());
