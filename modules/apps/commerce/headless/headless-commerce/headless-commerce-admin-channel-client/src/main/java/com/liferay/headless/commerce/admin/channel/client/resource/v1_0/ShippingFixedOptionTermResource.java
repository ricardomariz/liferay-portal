 ...
 */
@Generated("")
public interface ShippingFixedOptionTermResource {

	public static Builder builder() {
		return new Builder();
	}

	public void deleteShippingFixedOptionTerm(Long shippingFixedOptionTermId)
		throws Exception;

	public HttpInvoker.HttpResponse deleteShippingFixedOptionTermHttpResponse(
			Long shippingFixedOptionTermId)
		throws Exception;

	public void deleteShippingFixedOptionTermBatch(
	...
	public HttpInvoker.HttpResponse
			getShippingFixedOptionIdShippingFixedOptionTermsPageHttpResponse(
				Long id, String search, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postShippingFixedOptionIdShippingFixedOptionTermHttpResponse(
				Long id, ShippingFixedOptionTerm shippingFixedOptionTerm)
		throws Exception;
	...
	public static class Builder {
		...
		public ShippingFixedOptionTermResource build() {
	...
	public static class ShippingFixedOptionTermResourceImpl
		implements ShippingFixedOptionTermResource {
		...
		public Page<ShippingFixedOptionTerm>
			...
			try {
				return Page.of(content, ShippingFixedOptionTermSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public ShippingFixedOptionTerm
			...
			try {
				return ShippingFixedOptionTermSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				shippingFixedOptionTerm.toString(), "application/json");
		...
		private ShippingFixedOptionTermResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ShippingFixedOptionTermResource.class.getName());
