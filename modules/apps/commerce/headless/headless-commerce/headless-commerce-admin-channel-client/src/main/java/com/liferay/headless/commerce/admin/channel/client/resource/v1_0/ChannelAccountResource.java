 ...
 */
@Generated("")
public interface ChannelAccountResource {
	...
	public HttpInvoker.HttpResponse deleteChannelAccountHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getChannelByExternalReferenceCodeChannelAccountsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postChannelByExternalReferenceCodeChannelAccountHttpResponse(
				String externalReferenceCode, ChannelAccount channelAccount)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getChannelIdChannelAccountsPageHttpResponse(
			Long id, String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postChannelIdChannelAccountHttpResponse(
			Long id, ChannelAccount channelAccount)
		throws Exception;
	...
	public static class Builder {
		...
		public ChannelAccountResource build() {
			return new ChannelAccountResourceImpl(this);
		}
	...
	public static class ChannelAccountResourceImpl
		implements ChannelAccountResource {

		public void deleteChannelAccount(Long channelAccountId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteChannelAccountHttpResponse(channelAccountId);
		...
		public HttpInvoker.HttpResponse deleteChannelAccountHttpResponse(
			...
			httpInvoker.path("channelAccountId", channelAccountId);
		...
		public Page<ChannelAccount>
			...
			try {
				return Page.of(content, ChannelAccountSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public ChannelAccount postChannelByExternalReferenceCodeChannelAccount(
			...
			try {
				return ChannelAccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(channelAccount.toString(), "application/json");
		...
		public Page<ChannelAccount> getChannelIdChannelAccountsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelIdChannelAccountsPageHttpResponse(
		...
		public ChannelAccount postChannelIdChannelAccount(
			...
			HttpInvoker.HttpResponse httpResponse =
				postChannelIdChannelAccountHttpResponse(id, channelAccount);
		...
		private ChannelAccountResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ChannelAccountResource.class.getName());
