...
public interface AccountResource {
	...
	public Account getChannelAccountAccount(Long channelAccountId)
		throws Exception;

	public HttpInvoker.HttpResponse getChannelAccountAccountHttpResponse(
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Account getChannelAccountAccount(Long channelAccountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelAccountAccountHttpResponse(channelAccountId);
			...
			try {
				return com.liferay.headless.commerce.admin.channel.client.
					serdes.v1_0.AccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
