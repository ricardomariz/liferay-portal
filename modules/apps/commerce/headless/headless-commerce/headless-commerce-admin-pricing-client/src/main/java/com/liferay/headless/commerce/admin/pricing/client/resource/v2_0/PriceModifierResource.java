...
public interface PriceModifierResource {
	...
	public HttpInvoker.HttpResponse
			getPriceListByExternalReferenceCodePriceModifiersPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postPriceListByExternalReferenceCodePriceModifierHttpResponse(
				String externalReferenceCode, PriceModifier priceModifier)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postPriceListIdPriceModifierHttpResponse(
			Long id, PriceModifier priceModifier)
		throws Exception;
	...
	public void patchPriceModifierByExternalReferenceCode(
			String externalReferenceCode, PriceModifier priceModifier)
		throws Exception;

	public HttpInvoker.HttpResponse
			patchPriceModifierByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, PriceModifier priceModifier)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getPriceModifierHttpResponse(Long id)
		throws Exception;

	public void patchPriceModifier(Long id, PriceModifier priceModifier)
		throws Exception;

	public HttpInvoker.HttpResponse patchPriceModifierHttpResponse(
			Long id, PriceModifier priceModifier)
		throws Exception;
	...
	public static class PriceModifierResourceImpl
		implements PriceModifierResource {
		...
		public Page<PriceModifier>
			...
			try {
				return Page.of(content, PriceModifierSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/price-lists/by-externalReferenceCode/{externalReferenceCode}/price-modifiers");
		...
		public PriceModifier postPriceListByExternalReferenceCodePriceModifier(
			...
			try {
				return PriceModifierSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(priceModifier.toString(), "application/json");
		...
		public PriceModifier postPriceListIdPriceModifier(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPriceListIdPriceModifierHttpResponse(id, priceModifier);
		...
		public HttpInvoker.HttpResponse
				postPriceListIdPriceModifierHttpResponse(
					Long id, PriceModifier priceModifier)
			throws Exception {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/price-modifiers/by-externalReferenceCode/{externalReferenceCode}");
		...
		public void deletePriceModifier(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deletePriceModifierHttpResponse(id);
		...
		public HttpInvoker.HttpResponse deletePriceModifierHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/price-modifiers/{id}");
		...
		public PriceModifier getPriceModifier(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getPriceModifierHttpResponse(id);
		...
		public void patchPriceModifier(Long id, PriceModifier priceModifier)
			...
			HttpInvoker.HttpResponse httpResponse =
				patchPriceModifierHttpResponse(id, priceModifier);
		...
		private PriceModifierResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PriceModifierResource.class.getName());
