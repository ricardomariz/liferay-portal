...
public interface DiscountOrderTypeResource {
	...
	public HttpInvoker.HttpResponse deleteDiscountOrderTypeHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getDiscountByExternalReferenceCodeDiscountOrderTypesPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postDiscountByExternalReferenceCodeDiscountOrderTypeHttpResponse(
				String externalReferenceCode,
				DiscountOrderType discountOrderType)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getDiscountIdDiscountOrderTypesPageHttpResponse(
	...
	public HttpInvoker.HttpResponse postDiscountIdDiscountOrderTypeHttpResponse(
			Long id, DiscountOrderType discountOrderType)
		throws Exception;
	...
	public static class Builder {
		...
		public DiscountOrderTypeResource build() {
			return new DiscountOrderTypeResourceImpl(this);
		}
	...
	public static class DiscountOrderTypeResourceImpl
		implements DiscountOrderTypeResource {

		public void deleteDiscountOrderType(Long discountOrderTypeId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteDiscountOrderTypeHttpResponse(discountOrderTypeId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discount-order-types/{discountOrderTypeId}");

			httpInvoker.path("discountOrderTypeId", discountOrderTypeId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discount-order-types/batch");
		...
		public Page<DiscountOrderType>
			...
			try {
				return Page.of(content, DiscountOrderTypeSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discounts/by-externalReferenceCode/{externalReferenceCode}/discount-order-types");
		...
		public DiscountOrderType
			...
			try {
				return DiscountOrderTypeSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(discountOrderType.toString(), "application/json");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discounts/{id}/discount-order-types");
		...
		public DiscountOrderType postDiscountIdDiscountOrderType(
			...
			HttpInvoker.HttpResponse httpResponse =
				postDiscountIdDiscountOrderTypeHttpResponse(
		...
		private DiscountOrderTypeResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DiscountOrderTypeResource.class.getName());
