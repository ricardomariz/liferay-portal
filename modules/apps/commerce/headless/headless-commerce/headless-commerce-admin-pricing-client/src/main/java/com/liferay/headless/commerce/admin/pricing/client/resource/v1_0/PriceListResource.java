...
public interface PriceListResource {
	...
	public void postPriceListsPageExportBatch(
			String filterString, String sortString, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postPriceListsPageExportBatchHttpResponse(
			String filterString, String sortString, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postPriceListHttpResponse(
			PriceList priceList)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getPriceListByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchPriceListByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, PriceList priceList)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putPriceListByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, PriceList priceList)
		throws Exception;
	...
	public static class PriceListResourceImpl implements PriceListResource {
		...
		public Page<PriceList> getPriceListsPage(
			...
			try {
				return Page.of(content, PriceListSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/priceLists");
		...
		public void postPriceListsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPriceListsPageExportBatchHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/priceLists/export-batch");
		...
		public PriceList postPriceList(PriceList priceList) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postPriceListHttpResponse(
				priceList);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/priceLists/by-externalReferenceCode/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse deletePriceListHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/priceLists/{id}");
		...
		private PriceListResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PriceListResource.class.getName());
