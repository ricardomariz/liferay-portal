...
public interface OrderTypeResource {
	...
	public HttpInvoker.HttpResponse getDiscountOrderTypeOrderTypeHttpResponse(
	...
	public HttpInvoker.HttpResponse getPriceListOrderTypeOrderTypeHttpResponse(
	...
	public static class OrderTypeResourceImpl implements OrderTypeResource {
		...
		public OrderType getDiscountOrderTypeOrderType(Long discountOrderTypeId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getDiscountOrderTypeOrderTypeHttpResponse(discountOrderTypeId);
			...
			try {
				return com.liferay.headless.commerce.admin.pricing.client.
					serdes.v2_0.OrderTypeSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
				getDiscountOrderTypeOrderTypeHttpResponse(
					Long discountOrderTypeId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discount-order-types/{discountOrderTypeId}/order-type");
		...
		public OrderType getPriceListOrderTypeOrderType(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPriceListOrderTypeOrderTypeHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/price-list-order-types/{priceListOrderTypeId}/order-type");
