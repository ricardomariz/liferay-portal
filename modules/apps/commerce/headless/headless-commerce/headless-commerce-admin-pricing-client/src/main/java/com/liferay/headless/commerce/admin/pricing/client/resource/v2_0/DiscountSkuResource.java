...
public interface DiscountSkuResource {
	...
	public HttpInvoker.HttpResponse deleteDiscountSkuHttpResponse(
			Long discountSkuId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getDiscountByExternalReferenceCodeDiscountSkusPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postDiscountByExternalReferenceCodeDiscountSkuHttpResponse(
				String externalReferenceCode, DiscountSku discountSku)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getDiscountIdDiscountSkusPageHttpResponse(
			Long id, String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postDiscountIdDiscountSkuHttpResponse(
			Long id, DiscountSku discountSku)
		throws Exception;
	...
	public static class Builder {
		...
		public DiscountSkuResource build() {
			return new DiscountSkuResourceImpl(this);
		}
	...
	public static class DiscountSkuResourceImpl implements DiscountSkuResource {

		public void deleteDiscountSku(Long discountSkuId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteDiscountSkuHttpResponse(discountSkuId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discount-skus/{discountSkuId}");

			httpInvoker.path("discountSkuId", discountSkuId);
		...
		public HttpInvoker.HttpResponse deleteDiscountSkuBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discount-skus/batch");
		...
		public Page<DiscountSku>
			...
			try {
				return Page.of(content, DiscountSkuSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discounts/by-externalReferenceCode/{externalReferenceCode}/discount-skus");
		...
		public DiscountSku postDiscountByExternalReferenceCodeDiscountSku(
			...
			try {
				return DiscountSkuSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(discountSku.toString(), "application/json");
		...
		public Page<DiscountSku> getDiscountIdDiscountSkusPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDiscountIdDiscountSkusPageHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/discounts/{id}/discount-skus");
		...
		public DiscountSku postDiscountIdDiscountSku(
			...
			HttpInvoker.HttpResponse httpResponse =
				postDiscountIdDiscountSkuHttpResponse(id, discountSku);
		...
		private DiscountSkuResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DiscountSkuResource.class.getName());
