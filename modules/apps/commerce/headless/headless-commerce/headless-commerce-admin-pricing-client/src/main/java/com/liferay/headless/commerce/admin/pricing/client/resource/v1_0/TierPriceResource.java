...
public interface TierPriceResource {
	...
	public HttpInvoker.HttpResponse
			getPriceEntryByExternalReferenceCodeTierPricesPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postPriceEntryByExternalReferenceCodeTierPriceHttpResponse(
				String externalReferenceCode, TierPrice tierPrice)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getTierPriceByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;

	public void patchTierPriceByExternalReferenceCode(
			String externalReferenceCode, TierPrice tierPrice)
		throws Exception;

	public HttpInvoker.HttpResponse
			patchTierPriceByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, TierPrice tierPrice)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getTierPriceHttpResponse(Long id)
		throws Exception;

	public void patchTierPrice(Long id, TierPrice tierPrice) throws Exception;

	public HttpInvoker.HttpResponse patchTierPriceHttpResponse(
			Long id, TierPrice tierPrice)
		throws Exception;
	...
	public static class TierPriceResourceImpl implements TierPriceResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/priceEntries/by-externalReferenceCode/{externalReferenceCode}/tierPrices");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(tierPrice.toString(), "application/json");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/priceEntries/{id}/tierPrices");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/tierPrices/by-externalReferenceCode/{externalReferenceCode}");
		...
		public void deleteTierPrice(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteTierPriceHttpResponse(
				id);
		...
		public HttpInvoker.HttpResponse deleteTierPriceHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v1.0/tierPrices/{id}");
		...
		public TierPrice getTierPrice(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getTierPriceHttpResponse(
				id);
		...
		public void patchTierPrice(Long id, TierPrice tierPrice)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = patchTierPriceHttpResponse(
				id, tierPrice);
		...
		private static final Logger _logger = Logger.getLogger(
			TierPriceResource.class.getName());
