...
import com.liferay.headless.commerce.delivery.catalog.client.resource.v1_0.LinkedProductResource;
import com.liferay.headless.commerce.delivery.catalog.client.serdes.v1_0.LinkedProductSerDes;
...
public abstract class BaseLinkedProductResourceTestCase {
	...
	@Test
	public void testGetChannelProductLinkedProductsPage() throws Exception {
		Long channelId = testGetChannelProductLinkedProductsPage_getChannelId();
		Long irrelevantChannelId =
			testGetChannelProductLinkedProductsPage_getIrrelevantChannelId();
		Long productId = testGetChannelProductLinkedProductsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelProductLinkedProductsPage_getIrrelevantProductId();
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("productExternalReferenceCode")) {
			Object object = linkedProduct.getProductExternalReferenceCode();
		...
		if (entityFieldName.equals("type")) {
			Object object = linkedProduct.getType();
