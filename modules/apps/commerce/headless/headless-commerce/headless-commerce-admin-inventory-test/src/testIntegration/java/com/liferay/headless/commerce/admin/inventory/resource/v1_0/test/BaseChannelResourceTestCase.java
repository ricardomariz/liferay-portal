...
import com.liferay.headless.commerce.admin.inventory.client.resource.v1_0.ChannelResource;
...
public abstract class BaseChannelResourceTestCase {
	...
	@Test
	public void testGetWarehouseChannelChannel() throws Exception {
		Channel postChannel = testGetWarehouseChannelChannel_addChannel();

		Channel getChannel = channelResource.getWarehouseChannelChannel(
			testGetWarehouseChannelChannel_getWarehouseChannelId());
	...
	protected Channel testGraphQLGetWarehouseChannelChannel_addChannel()
		throws Exception {
