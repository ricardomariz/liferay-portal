...
import com.liferay.headless.commerce.admin.inventory.client.resource.v1_0.OrderTypeResource;
import com.liferay.headless.commerce.admin.inventory.client.serdes.v1_0.OrderTypeSerDes;
...
public abstract class BaseOrderTypeResourceTestCase {
	...
	@Test
	public void testGetWarehouseOrderTypeOrderType() throws Exception {
		OrderType postOrderType =
			testGetWarehouseOrderTypeOrderType_addOrderType();

		OrderType getOrderType =
			orderTypeResource.getWarehouseOrderTypeOrderType(
				testGetWarehouseOrderTypeOrderType_getWarehouseOrderTypeId());
	...
	public void testGraphQLGetWarehouseOrderTypeOrderType() throws Exception {
		OrderType orderType =
			testGraphQLGetWarehouseOrderTypeOrderType_addOrderType();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								getGraphQLFields())),
						"JSONObject/data",
						"Object/warehouseOrderTypeOrderType"))));
	...
	public void testGraphQLGetWarehouseOrderTypeOrderTypeNotFound()
		...
		Long irrelevantWarehouseOrderTypeId = RandomTestUtil.randomLong();
						...
						new HashMap<String, Object>() {
							{
								put(
									"warehouseOrderTypeId",
									irrelevantWarehouseOrderTypeId);
							}
						},
						getGraphQLFields())),
	...
	protected OrderType testGraphQLGetWarehouseOrderTypeOrderType_addOrderType()
		throws Exception {
