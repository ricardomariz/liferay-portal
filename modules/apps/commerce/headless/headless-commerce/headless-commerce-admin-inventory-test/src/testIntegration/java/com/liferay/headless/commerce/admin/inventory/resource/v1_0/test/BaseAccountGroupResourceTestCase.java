...
import com.liferay.headless.commerce.admin.inventory.client.resource.v1_0.AccountGroupResource;
import com.liferay.headless.commerce.admin.inventory.client.serdes.v1_0.AccountGroupSerDes;
...
public abstract class BaseAccountGroupResourceTestCase {
	...
	@Test
	public void testGetWarehouseAccountGroupAccountGroup() throws Exception {
	...
	@Test
	public void testGraphQLGetWarehouseAccountGroupAccountGroup()
		throws Exception {

		AccountGroup accountGroup =
			testGraphQLGetWarehouseAccountGroupAccountGroup_addAccountGroup();
			...
			equals(
				...
				AccountGroupSerDes.toDTO(
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								"warehouseAccountGroupAccountGroup",
								...
								getGraphQLFields())),
						"JSONObject/data",
						"Object/warehouseAccountGroupAccountGroup"))));
	...
	@Test
	public void testGraphQLGetWarehouseAccountGroupAccountGroupNotFound()
		throws Exception {

		Long irrelevantWarehouseAccountGroupId = RandomTestUtil.randomLong();
						...
						new HashMap<String, Object>() {
							{
								put(
									"warehouseAccountGroupId",
									irrelevantWarehouseAccountGroupId);
							}
						},
						getGraphQLFields())),
