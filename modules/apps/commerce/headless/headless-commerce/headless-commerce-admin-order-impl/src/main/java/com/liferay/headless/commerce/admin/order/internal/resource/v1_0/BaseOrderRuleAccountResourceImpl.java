...
public abstract class BaseOrderRuleAccountResourceImpl
	implements EntityModelResource, OrderRuleAccountResource,
			   VulcanBatchEngineTaskItemDelegate<OrderRuleAccount> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "OrderRuleAccount")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-rule-accounts/{orderRuleAccountId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteOrderRuleAccount(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-order/v1.0/order-rule-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-rule-accounts/batch")
	...
	public Response deleteOrderRuleAccountBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				OrderRuleAccount.class.getName(), callbackURL, object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/order-rules/by-externalReferenceCode/{externalReferenceCode}/order-rule-accounts"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/order-rules/{id}/order-rule-accounts")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-order/v1.0/order-rules/order-rule-accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/order-rules/order-rule-accounts/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postOrderRuleIdOrderRuleAccountBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				OrderRuleAccount.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public void create(
			Collection<OrderRuleAccount> orderRuleAccounts,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<OrderRuleAccount, OrderRuleAccount, Exception>
			orderRuleAccountUnsafeFunction = null;
		...
		if (orderRuleAccountUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for OrderRuleAccount");
		}
