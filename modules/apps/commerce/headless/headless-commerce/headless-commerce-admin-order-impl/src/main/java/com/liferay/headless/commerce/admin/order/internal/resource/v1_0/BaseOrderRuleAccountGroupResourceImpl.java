...
public abstract class BaseOrderRuleAccountGroupResourceImpl
	implements EntityModelResource, OrderRuleAccountGroupResource,
			   VulcanBatchEngineTaskItemDelegate<OrderRuleAccountGroup> {
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-rule-account-groups/{orderRuleAccountGroupId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteOrderRuleAccountGroup(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-order/v1.0/order-rule-account-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-rule-account-groups/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/order-rules/{id}/order-rule-account-groups")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-order/v1.0/order-rules/order-rule-account-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/order-rules/order-rule-account-groups/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postOrderRuleIdOrderRuleAccountGroupBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				OrderRuleAccountGroup.class.getName(), callbackURL, null,
				object)
		).build();
	}
	...
	public void create(
			Collection<OrderRuleAccountGroup> orderRuleAccountGroups,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<OrderRuleAccountGroup, OrderRuleAccountGroup, Exception>
			orderRuleAccountGroupUnsafeFunction = null;
		...
		if (orderRuleAccountGroupUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for OrderRuleAccountGroup");
		}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<OrderRuleAccountGroup>,
			 UnsafeFunction
				 <OrderRuleAccountGroup, OrderRuleAccountGroup, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<OrderRuleAccountGroup>,
			 UnsafeConsumer<OrderRuleAccountGroup, Exception>, Exception>
