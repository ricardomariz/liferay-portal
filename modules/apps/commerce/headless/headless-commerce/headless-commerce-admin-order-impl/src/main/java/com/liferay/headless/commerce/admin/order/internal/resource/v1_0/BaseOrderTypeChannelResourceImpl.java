...
public abstract class BaseOrderTypeChannelResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "OrderTypeChannel")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-type-channels/{orderTypeChannelId}")
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-type-channels/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/order-types/{id}/order-type-channels")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/order-types/order-type-channels/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<OrderTypeChannel> orderTypeChannels,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<OrderTypeChannel, OrderTypeChannel, Exception>
			orderTypeChannelUnsafeFunction = null;
		...
		if (orderTypeChannelUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for OrderTypeChannel");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				orderTypeChannels, orderTypeChannelUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				orderTypeChannels, orderTypeChannelUnsafeFunction::apply);
		}
		else {
			for (OrderTypeChannel orderTypeChannel : orderTypeChannels) {
				orderTypeChannelUnsafeFunction.apply(orderTypeChannel);
			}
		}
	}
