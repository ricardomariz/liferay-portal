...
public abstract class BaseOrderRuleChannelResourceImpl
	implements EntityModelResource, OrderRuleChannelResource,
			   VulcanBatchEngineTaskItemDelegate<OrderRuleChannel> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "OrderRuleChannel")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-rule-channels/{orderRuleChannelId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteOrderRuleChannel(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-order/v1.0/order-rule-channels/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/order-rule-channels/batch")
	...
	public Response deleteOrderRuleChannelBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				OrderRuleChannel.class.getName(), callbackURL, object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/order-rules/{id}/order-rule-channels")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-order/v1.0/order-rules/order-rule-channels/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/order-rules/order-rule-channels/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postOrderRuleIdOrderRuleChannelBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				OrderRuleChannel.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public void create(
			Collection<OrderRuleChannel> orderRuleChannels,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<OrderRuleChannel, OrderRuleChannel, Exception>
			orderRuleChannelUnsafeFunction = null;
		...
		if (orderRuleChannelUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for OrderRuleChannel");
		}
