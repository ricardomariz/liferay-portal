...
public abstract class BasePaymentMethodResourceTestCase {
	...
	protected Long testGetCartPaymentMethodsPage_getIrrelevantCartId()
		throws Exception {
	...
	protected void assertValid(PaymentMethod paymentMethod) throws Exception {
		boolean valid = true;
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("description")) {
			Object object = paymentMethod.getDescription();
		...
		if (entityFieldName.equals("key")) {
			Object object = paymentMethod.getKey();
		...
		if (entityFieldName.equals("name")) {
			Object object = paymentMethod.getName();
