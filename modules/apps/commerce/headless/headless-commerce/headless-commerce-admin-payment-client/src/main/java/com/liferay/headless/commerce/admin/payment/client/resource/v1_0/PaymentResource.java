...
package com.liferay.headless.commerce.admin.payment.client.resource.v1_0;
...
import com.liferay.headless.commerce.admin.payment.client.problem.Problem;
...
public interface PaymentResource {
	...
	public HttpInvoker.HttpResponse getPaymentsPageHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;

	public void postPaymentsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postPaymentsPageExportBatchHttpResponse(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			deletePaymentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getPaymentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchPaymentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Payment payment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putPaymentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Payment payment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postPaymentByExternalReferenceCodeRefundHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getPaymentHttpResponse(Long id)
		throws Exception;

	public Payment patchPayment(Long id, Payment payment) throws Exception;

	public HttpInvoker.HttpResponse patchPaymentHttpResponse(
			Long id, Payment payment)
		throws Exception;

	public Payment postPaymentRefund(Long id) throws Exception;

	public HttpInvoker.HttpResponse postPaymentRefundHttpResponse(Long id)
		throws Exception;
	...
	public static class Builder {
		...
		public PaymentResource build() {
			return new PaymentResourceImpl(this);
		}
	...
	public static class PaymentResourceImpl implements PaymentResource {
		...
		public Page<Payment> getPaymentsPage(
			...
			HttpInvoker.HttpResponse httpResponse = getPaymentsPageHttpResponse(
			...
			try {
				return Page.of(content, PaymentSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public void postPaymentsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPaymentsPageExportBatchHttpResponse(
		...
		public Payment postPayment(Payment payment) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postPaymentHttpResponse(
				payment);
			...
			try {
				return PaymentSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postPaymentHttpResponse(Payment payment)
			...
			httpInvoker.body(payment.toString(), "application/json");
		...
		public void deletePayment(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deletePaymentHttpResponse(
				id);
		...
		public Payment getPayment(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getPaymentHttpResponse(id);
		...
		public Payment patchPayment(Long id, Payment payment) throws Exception {
			HttpInvoker.HttpResponse httpResponse = patchPaymentHttpResponse(
				id, payment);
		...
		public Payment postPaymentRefund(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				postPaymentRefundHttpResponse(id);
		...
		private PaymentResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PaymentResource.class.getName());
