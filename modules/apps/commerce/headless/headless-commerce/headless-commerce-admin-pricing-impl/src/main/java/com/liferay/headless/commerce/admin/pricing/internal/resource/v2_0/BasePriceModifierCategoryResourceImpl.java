...
public abstract class BasePriceModifierCategoryResourceImpl
	implements EntityModelResource, PriceModifierCategoryResource,
			   VulcanBatchEngineTaskItemDelegate<PriceModifierCategory> {
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-modifier-categories/{priceModifierCategoryId}")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-modifier-categories/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-modifier-categories/batch")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-modifiers/by-externalReferenceCode/{externalReferenceCode}/price-modifier-categories'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/price-modifiers/by-externalReferenceCode/{externalReferenceCode}/price-modifier-categories"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/price-modifiers/{id}/price-modifier-categories")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<PriceModifierCategory>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-modifiers/price-modifier-categories/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/price-modifiers/price-modifier-categories/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postPriceModifierIdPriceModifierCategoryBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				PriceModifierCategory.class.getName(), callbackURL, null,
				object)
		).build();
	}
	...
	public void create(
			Collection<PriceModifierCategory> priceModifierCategories,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<PriceModifierCategory, PriceModifierCategory, Exception>
			priceModifierCategoryUnsafeFunction = null;
		...
		if (priceModifierCategoryUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for PriceModifierCategory");
		}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<PriceModifierCategory>,
			 UnsafeFunction
				 <PriceModifierCategory, PriceModifierCategory, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<PriceModifierCategory>,
			 UnsafeConsumer<PriceModifierCategory, Exception>, Exception>
