...
public abstract class BasePriceListAccountGroupResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "PriceListAccountGroup"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-list-account-groups/{priceListAccountGroupId}")
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-list-account-groups/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/price-lists/{id}/price-list-account-groups")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/price-lists/price-list-account-groups/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<PriceListAccountGroup> priceListAccountGroups,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<PriceListAccountGroup, PriceListAccountGroup, Exception>
			priceListAccountGroupUnsafeFunction = null;
		...
		if (priceListAccountGroupUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for PriceListAccountGroup");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				priceListAccountGroups, priceListAccountGroupUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				priceListAccountGroups,
				priceListAccountGroupUnsafeFunction::apply);
		}
		else {
