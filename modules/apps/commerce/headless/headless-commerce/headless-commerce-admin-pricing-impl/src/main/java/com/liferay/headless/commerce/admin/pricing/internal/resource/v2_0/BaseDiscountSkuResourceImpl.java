...
public abstract class BaseDiscountSkuResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "DiscountSku")}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/discount-skus/{discountSkuId}")
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/discount-skus/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/discounts/{id}/discount-skus")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/discounts/discount-skus/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<DiscountSku> discountSkus,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<DiscountSku, DiscountSku, Exception>
			discountSkuUnsafeFunction = null;
		...
		if (discountSkuUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for DiscountSku");
		}
