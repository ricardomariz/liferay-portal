...
public abstract class BaseDiscountOrderTypeResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "DiscountOrderType")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/discount-order-types/{discountOrderTypeId}")
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/discount-order-types/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/discounts/{id}/discount-order-types")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/discounts/discount-order-types/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<DiscountOrderType> discountOrderTypes,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<DiscountOrderType, DiscountOrderType, Exception>
			discountOrderTypeUnsafeFunction = null;
		...
		if (discountOrderTypeUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for DiscountOrderType");
		}
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<DiscountOrderType>,
			 UnsafeConsumer<DiscountOrderType, Exception>, Exception>
