...
public abstract class BasePriceListOrderTypeResourceImpl
	implements EntityModelResource, PriceListOrderTypeResource,
			   VulcanBatchEngineTaskItemDelegate<PriceListOrderType> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "PriceListOrderType")
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-list-order-types/{priceListOrderTypeId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deletePriceListOrderType(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-list-order-types/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-list-order-types/batch")
	...
	public Response deletePriceListOrderTypeBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				PriceListOrderType.class.getName(), callbackURL, object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-lists/by-externalReferenceCode/{externalReferenceCode}/price-list-order-types'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/price-lists/by-externalReferenceCode/{externalReferenceCode}/price-list-order-types"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-lists/by-externalReferenceCode/{externalReferenceCode}/price-list-order-types' -d $'{"orderTypeExternalReferenceCode": ___, "orderTypeId": ___, "priceListExternalReferenceCode": ___, "priceListId": ___, "priority": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/price-lists/{id}/price-list-order-types")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-lists/price-list-order-types/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/price-lists/price-list-order-types/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postPriceListIdPriceListOrderTypeBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				PriceListOrderType.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public void create(
			Collection<PriceListOrderType> priceListOrderTypes,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<PriceListOrderType, PriceListOrderType, Exception>
			priceListOrderTypeUnsafeFunction = null;
		...
		if (priceListOrderTypeUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for PriceListOrderType");
		}
