...
public abstract class BaseDiscountAccountGroupResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "DiscountAccountGroup"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/discount-account-groups/{discountAccountGroupId}")
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/discount-account-groups/batch")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/discounts/{id}/discount-account-groups")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/discounts/discount-account-groups/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<DiscountAccountGroup> discountAccountGroups,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<DiscountAccountGroup, DiscountAccountGroup, Exception>
			discountAccountGroupUnsafeFunction = null;
		...
		if (discountAccountGroupUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for DiscountAccountGroup");
		}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<DiscountAccountGroup>,
			 UnsafeFunction
				 <DiscountAccountGroup, DiscountAccountGroup, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<DiscountAccountGroup>,
			 UnsafeConsumer<DiscountAccountGroup, Exception>, Exception>
