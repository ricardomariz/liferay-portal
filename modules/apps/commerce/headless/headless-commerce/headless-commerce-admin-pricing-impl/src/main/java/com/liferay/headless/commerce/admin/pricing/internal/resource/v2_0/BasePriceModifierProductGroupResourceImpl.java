...
public abstract class BasePriceModifierProductGroupResourceImpl
	implements EntityModelResource, PriceModifierProductGroupResource,
			   VulcanBatchEngineTaskItemDelegate<PriceModifierProductGroup> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "PriceModifierProductGroup"
			)
		}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/price-modifier-product-groups/{priceModifierProductGroupId}"
	)
	...
	public void deletePriceModifierProductGroup(
			...
			@javax.ws.rs.PathParam("priceModifierProductGroupId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-modifier-product-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/price-modifier-product-groups/batch")
	...
	public Response deletePriceModifierProductGroupBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				PriceModifierProductGroup.class.getName(), callbackURL, object)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/price-modifiers/{id}/price-modifier-product-groups")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<PriceModifierProductGroup>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-pricing/v2.0/price-modifiers/price-modifier-product-groups/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/price-modifiers/price-modifier-product-groups/batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postPriceModifierIdPriceModifierProductGroupBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				PriceModifierProductGroup.class.getName(), callbackURL, null,
				object)
		).build();
	}
	...
	public void create(
			Collection<PriceModifierProductGroup> priceModifierProductGroups,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction
			<PriceModifierProductGroup, PriceModifierProductGroup, Exception>
				priceModifierProductGroupUnsafeFunction = null;
		...
		if (priceModifierProductGroupUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for PriceModifierProductGroup");
		}
		...
		if (contextBatchUnsafeBiConsumer != null) {
			...
			contextBatchUnsafeConsumer.accept(
				priceModifierProductGroups,
				priceModifierProductGroupUnsafeFunction::apply);
		}
		else {
