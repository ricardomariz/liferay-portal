...
public interface TermResource {
	...
	public HttpInvoker.HttpResponse
			getCartByExternalReferenceCodeDeliveryTermsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getCartByExternalReferenceCodePaymentTermsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;

	public Page<Term> getCartDeliveryTermsPage(Long cartId) throws Exception;

	public HttpInvoker.HttpResponse getCartDeliveryTermsPageHttpResponse(
			Long cartId)
		throws Exception;

	public Page<Term> getCartPaymentTermsPage(Long cartId) throws Exception;

	public HttpInvoker.HttpResponse getCartPaymentTermsPageHttpResponse(
			Long cartId)
		throws Exception;
	...
	public static class TermResourceImpl implements TermResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/by-externalReferenceCode/{externalReferenceCode}/delivery-terms");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/by-externalReferenceCode/{externalReferenceCode}/payment-terms");
		...
		public Page<Term> getCartDeliveryTermsPage(Long cartId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getCartDeliveryTermsPageHttpResponse(cartId);
		...
		public HttpInvoker.HttpResponse getCartDeliveryTermsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/delivery-terms");
		...
		public Page<Term> getCartPaymentTermsPage(Long cartId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getCartPaymentTermsPageHttpResponse(cartId);
		...
		public HttpInvoker.HttpResponse getCartPaymentTermsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/payment-terms");
