...
public interface PaymentMethodResource {
	...
	public HttpInvoker.HttpResponse
			getCartByExternalReferenceCodePaymentMethodsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getCartPaymentMethodsPageHttpResponse(
			Long cartId)
		throws Exception;

	public void postCartPaymentMethodsPageExportBatch(
			Long cartId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postCartPaymentMethodsPageExportBatchHttpResponse(
				Long cartId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public PaymentMethodResource build() {
			return new PaymentMethodResourceImpl(this);
		}
	...
	public static class PaymentMethodResourceImpl
		implements PaymentMethodResource {

		public Page<PaymentMethod>
			...
			try {
				return Page.of(content, PaymentMethodSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/by-externalReferenceCode/{externalReferenceCode}/payment-methods");
		...
		public Page<PaymentMethod> getCartPaymentMethodsPage(Long cartId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getCartPaymentMethodsPageHttpResponse(cartId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/payment-methods/export-batch");
		...
		private PaymentMethodResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PaymentMethodResource.class.getName());
