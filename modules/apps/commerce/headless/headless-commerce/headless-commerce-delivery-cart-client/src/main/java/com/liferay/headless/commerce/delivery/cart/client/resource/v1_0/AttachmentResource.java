...
public interface AttachmentResource {
	...
	public HttpInvoker.HttpResponse getCartAttachmentsPageHttpResponse(
			Long cartId, Pagination pagination)
		throws Exception;
	...
	public static class AttachmentResourceImpl implements AttachmentResource {
		...
		public void
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteCartByExternalReferenceCodeAttachmentByExternalReferenceCodeAttachmentExternalReferenceCodeHttpResponse(
					attachmentExternalReferenceCode, externalReferenceCode);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/by-externalReferenceCode/{externalReferenceCode}/attachments/by-externalReferenceCode/{attachmentExternalReferenceCode}");
		...
		public Page<Attachment> getCartAttachmentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getCartAttachmentsPageHttpResponse(cartId, pagination);
		...
		public HttpInvoker.HttpResponse getCartAttachmentsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/attachments");
		...
		public Attachment postCartAttachmentByBase64(
			...
			HttpInvoker.HttpResponse httpResponse =
				postCartAttachmentByBase64HttpResponse(
		...
		public HttpInvoker.HttpResponse postCartAttachmentByBase64HttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/attachments/by-base64");
