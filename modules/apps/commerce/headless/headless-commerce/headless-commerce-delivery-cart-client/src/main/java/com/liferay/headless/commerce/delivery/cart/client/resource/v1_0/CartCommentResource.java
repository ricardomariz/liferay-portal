...
public interface CartCommentResource {
	...
	public HttpInvoker.HttpResponse
			patchCartCommentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, CartComment cartComment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putCartCommentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, CartComment cartComment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getCartByExternalReferenceCodeCommentsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postCartByExternalReferenceCodeCommentHttpResponse(
				String externalReferenceCode, CartComment cartComment)
		throws Exception;
	...
	public static class CartCommentResourceImpl implements CartCommentResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/cart-comments/by-externalReferenceCode/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/by-externalReferenceCode/{externalReferenceCode}/comments");
