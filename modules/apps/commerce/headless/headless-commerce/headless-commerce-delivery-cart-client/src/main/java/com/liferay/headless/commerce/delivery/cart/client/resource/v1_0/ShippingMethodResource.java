...
public interface ShippingMethodResource {
	...
	public HttpInvoker.HttpResponse
			getCartByExternalReferenceCodeShippingMethodsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public void postCartShippingMethodsPageExportBatch(
			Long cartId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postCartShippingMethodsPageExportBatchHttpResponse(
				Long cartId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class ShippingMethodResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/by-externalReferenceCode/{externalReferenceCode}/shipping-methods");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/shipping-methods/export-batch");
