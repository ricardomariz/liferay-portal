 ...
 */
@Generated("")
public interface CartTransitionResource {
	...
	public HttpInvoker.HttpResponse getCartCartTransitionsPageHttpResponse(
			Long cartId)
		throws Exception;

	public void postCartCartTransitionsPageExportBatch(
			Long cartId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postCartCartTransitionsPageExportBatchHttpResponse(
				Long cartId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postCartCartTransitionHttpResponse(
			Long cartId, CartTransition cartTransition)
		throws Exception;
	...
	public static class Builder {
		...
		public CartTransitionResource build() {
			return new CartTransitionResourceImpl(this);
		}
	...
	public static class CartTransitionResourceImpl
		implements CartTransitionResource {

		public Page<CartTransition> getCartCartTransitionsPage(Long cartId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getCartCartTransitionsPageHttpResponse(cartId);
			...
			try {
				return Page.of(content, CartTransitionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/cart-transitions");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-cart/v1.0/carts/{cartId}/cart-transitions/export-batch");
		...
		public CartTransition postCartCartTransition(
			...
			HttpInvoker.HttpResponse httpResponse =
				postCartCartTransitionHttpResponse(cartId, cartTransition);
			...
			try {
				return CartTransitionSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postCartCartTransitionHttpResponse(
			...
			httpInvoker.body(cartTransition.toString(), "application/json");
		...
		private CartTransitionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			CartTransitionResource.class.getName());
