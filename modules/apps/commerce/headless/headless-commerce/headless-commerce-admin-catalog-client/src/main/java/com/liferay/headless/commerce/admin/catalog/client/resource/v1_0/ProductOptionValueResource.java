...
public interface ProductOptionValueResource {
	...
	public HttpInvoker.HttpResponse deleteProductOptionValueHttpResponse(
			Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getProductOptionValueHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchProductOptionValueHttpResponse(
			Long id, ProductOptionValue productOptionValue)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postProductOptionIdProductOptionValueHttpResponse(
				Long id, ProductOptionValue productOptionValue)
		throws Exception;
	...
	public static class ProductOptionValueResourceImpl
		implements ProductOptionValueResource {

		public void deleteProductOptionValue(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteProductOptionValueHttpResponse(id);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/product-option-values/{id}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/product-option-values/batch");
		...
		public ProductOptionValue getProductOptionValue(Long id)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getProductOptionValueHttpResponse(id);
		...
		public HttpInvoker.HttpResponse getProductOptionValueHttpResponse(
				Long id)
			throws Exception {
		...
		public ProductOptionValue patchProductOptionValue(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchProductOptionValueHttpResponse(id, productOptionValue);
		...
		public HttpInvoker.HttpResponse patchProductOptionValueHttpResponse(
			...
			httpInvoker.body(productOptionValue.toString(), "application/json");
		...
		private ProductOptionValueResourceImpl(Builder builder) {
			_builder = builder;
		}
