...
public interface ProductChannelResource {
	...
	public HttpInvoker.HttpResponse getProductChannelHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeProductChannelsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getProductIdProductChannelsPageHttpResponse(
			Long id, Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public ProductChannelResource build() {
			return new ProductChannelResourceImpl(this);
		}
	...
	public static class ProductChannelResourceImpl
		implements ProductChannelResource {

		public void deleteProductChannel(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteProductChannelHttpResponse(id);
		...
		public HttpInvoker.HttpResponse deleteProductChannelHttpResponse(
				Long id)
			throws Exception {
		...
		public ProductChannel getProductChannel(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getProductChannelHttpResponse(id);
			...
			try {
				return ProductChannelSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<ProductChannel>
			...
			try {
				return Page.of(content, ProductChannelSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<ProductChannel> getProductIdProductChannelsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getProductIdProductChannelsPageHttpResponse(id, pagination);
		...
		public HttpInvoker.HttpResponse
				getProductIdProductChannelsPageHttpResponse(
					Long id, Pagination pagination)
			throws Exception {
		...
		private ProductChannelResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ProductChannelResource.class.getName());
