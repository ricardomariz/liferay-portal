...
public interface AttachmentResource {
	...
	public HttpInvoker.HttpResponse
			getAttachmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchAttachmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Attachment attachment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putAttachmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Attachment attachment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeAttachmentsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postProductByExternalReferenceCodeAttachmentHttpResponse(
				String externalReferenceCode, Attachment attachment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeImagesPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postProductByExternalReferenceCodeImageHttpResponse(
				String externalReferenceCode, Attachment attachment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getProductIdAttachmentsPageHttpResponse(
			Long id, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postProductIdAttachmentHttpResponse(
	...
	public HttpInvoker.HttpResponse getProductIdImagesPageHttpResponse(
			Long id, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postProductIdImageHttpResponse(
			Long id, Attachment attachment)
		throws Exception;
	...
	public static class AttachmentResourceImpl implements AttachmentResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(attachment.toString(), "application/json");
		...
		public void deleteAttachment(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteAttachmentHttpResponse(id);
		...
		public HttpInvoker.HttpResponse deleteAttachmentHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/attachment/{id}");
		...
		public HttpInvoker.HttpResponse deleteAttachmentBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/attachment/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/attachments/by-base64");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(attachmentUrl.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/attachments/by-url");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/images/by-base64");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/images/by-url");
		...
		public Page<Attachment> getProductIdAttachmentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getProductIdAttachmentsPageHttpResponse(id, pagination);
		...
		public HttpInvoker.HttpResponse getProductIdAttachmentsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/attachments");
		...
		public Attachment postProductIdAttachment(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdAttachmentHttpResponse(id, attachment);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/attachments/by-base64");
		...
		public Attachment postProductIdAttachmentByUrl(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdAttachmentByUrlHttpResponse(id, attachmentUrl);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/attachments/by-url");
		...
		public Page<Attachment> getProductIdImagesPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getProductIdImagesPageHttpResponse(id, pagination);
		...
		public Attachment postProductIdImage(Long id, Attachment attachment)
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdImageHttpResponse(id, attachment);
		...
		public Attachment postProductIdImageByBase64(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdImageByBase64HttpResponse(id, attachmentBase64);
		...
		public HttpInvoker.HttpResponse postProductIdImageByBase64HttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/images/by-base64");
		...
		public Attachment postProductIdImageByUrl(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdImageByUrlHttpResponse(id, attachmentUrl);
		...
		public HttpInvoker.HttpResponse postProductIdImageByUrlHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/images/by-url");
