...
public interface SpecificationResource {
	...
	public void postSpecificationsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSpecificationsPageExportBatchHttpResponse(
				String search, String filterString, String sortString,
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchSpecificationByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Specification specification)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putSpecificationByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, Specification specification)
		throws Exception;
	...
	public static class SpecificationResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/specifications/export-batch");
