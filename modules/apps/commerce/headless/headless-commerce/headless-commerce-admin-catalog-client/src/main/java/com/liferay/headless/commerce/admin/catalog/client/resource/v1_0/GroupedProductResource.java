...
public interface GroupedProductResource {
	...
	public HttpInvoker.HttpResponse deleteGroupedProductHttpResponse(
	...
	public HttpInvoker.HttpResponse patchGroupedProductHttpResponse(
			Long groupedProductId, GroupedProduct groupedProduct)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeGroupedProductsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postProductByExternalReferenceCodeGroupedProductHttpResponse(
				String externalReferenceCode, GroupedProduct groupedProduct)
		throws Exception;
	...
	public static class GroupedProductResourceImpl
		implements GroupedProductResource {

		public void deleteGroupedProduct(Long groupedProductId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteGroupedProductHttpResponse(groupedProductId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/grouped-products/{groupedProductId}");

			httpInvoker.path("groupedProductId", groupedProductId);
		...
		public HttpInvoker.HttpResponse deleteGroupedProductBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/grouped-products/batch");
		...
		public GroupedProduct patchGroupedProduct(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchGroupedProductHttpResponse(
		...
		public HttpInvoker.HttpResponse patchGroupedProductHttpResponse(
			...
			httpInvoker.body(groupedProduct.toString(), "application/json");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/grouped-products");
		...
		private static final Logger _logger = Logger.getLogger(
			GroupedProductResource.class.getName());
