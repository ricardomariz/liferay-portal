...
public interface ListTypeDefinitionResource {
	...
	public HttpInvoker.HttpResponse
			getSpecificationIdListTypeDefinitionsPageHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postSpecificationIdListTypeDefinitionHttpResponse(
				Long id, ListTypeDefinition listTypeDefinition)
		throws Exception;
	...
	public static class ListTypeDefinitionResourceImpl
		...
		public Page<ListTypeDefinition>
				getSpecificationIdListTypeDefinitionsPage(Long id)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getSpecificationIdListTypeDefinitionsPageHttpResponse(id);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/specifications/{id}/list-type-definitions");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/specifications/list-type-definitions/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/specifications/{specificationId}/list-type-definitions/{listTypeDefinitionId}");

			httpInvoker.path("specificationId", specificationId);
