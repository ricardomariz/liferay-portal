...
public interface MappedProductResource {
	...
	public HttpInvoker.HttpResponse deleteMappedProductHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeMappedProductsPageHttpResponse(
				String externalReferenceCode, String search,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public static class Builder {
		...
		public MappedProductResource build() {
			return new MappedProductResourceImpl(this);
		}
	...
	public static class MappedProductResourceImpl
		implements MappedProductResource {

		public void deleteMappedProduct(Long mappedProductId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteMappedProductHttpResponse(mappedProductId);
		...
		public Page<MappedProduct>
			...
			try {
				return Page.of(content, MappedProductSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/mapped-products");
		...
		public MappedProduct postProductIdMappedProduct(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdMappedProductHttpResponse(id, mappedProduct);
		...
		private MappedProductResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			MappedProductResource.class.getName());
