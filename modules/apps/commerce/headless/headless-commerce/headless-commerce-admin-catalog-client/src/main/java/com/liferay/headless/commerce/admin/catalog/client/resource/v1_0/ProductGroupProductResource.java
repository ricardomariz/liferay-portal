 ...
 */
@Generated("")
public interface ProductGroupProductResource {
	...
	public HttpInvoker.HttpResponse deleteProductGroupProductHttpResponse(
			Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductGroupByExternalReferenceCodeProductGroupProductsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postProductGroupByExternalReferenceCodeProductGroupProductHttpResponse(
				String externalReferenceCode,
				ProductGroupProduct productGroupProduct)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductGroupIdProductGroupProductsPageHttpResponse(
				Long id, Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public ProductGroupProductResource build() {
	...
	public static class ProductGroupProductResourceImpl
		implements ProductGroupProductResource {

		public void deleteProductGroupProduct(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteProductGroupProductHttpResponse(id);
		...
		public Page<ProductGroupProduct>
			...
			try {
				return Page.of(content, ProductGroupProductSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public ProductGroupProduct
			...
			try {
				return ProductGroupProductSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				productGroupProduct.toString(), "application/json");
		...
		private ProductGroupProductResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ProductGroupProductResource.class.getName());
