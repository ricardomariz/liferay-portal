...
public interface ProductVirtualSettingsResource {
	...
	public static class Builder {
		...
		public ProductVirtualSettingsResource build() {
			return new ProductVirtualSettingsResourceImpl(this);
		}
	...
	public static class ProductVirtualSettingsResourceImpl
		...
		public ProductVirtualSettings
			...
			try {
				return com.liferay.headless.commerce.admin.catalog.client.
					serdes.v1_0.ProductVirtualSettingsSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private ProductVirtualSettingsResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ProductVirtualSettingsResource.class.getName());
