...
public interface ProductGroupResource {
	...
	public void postProductGroupsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postProductGroupsPageExportBatchHttpResponse(
				String search, String filterString, String sortString,
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putProductGroupByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, ProductGroup productGroup)
		throws Exception;
	...
	public static class ProductGroupResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/product-groups/export-batch");
