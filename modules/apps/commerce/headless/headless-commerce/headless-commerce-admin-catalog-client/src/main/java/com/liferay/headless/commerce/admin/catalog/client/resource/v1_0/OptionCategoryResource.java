...
public interface OptionCategoryResource {
	...
	public HttpInvoker.HttpResponse getOptionCategoriesPageHttpResponse(
			String filterString, Pagination pagination, String sortString)
		throws Exception;

	public void postOptionCategoriesPageExportBatch(
			String filterString, String sortString, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postOptionCategoriesPageExportBatchHttpResponse(
				String filterString, String sortString, String callbackURL,
				String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postOptionCategoryHttpResponse(
			OptionCategory optionCategory)
		throws Exception;

	public void postOptionCategoryBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postOptionCategoryBatchHttpResponse(
	...
	public HttpInvoker.HttpResponse
			patchOptionCategoryByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, OptionCategory optionCategory)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putOptionCategoryByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, OptionCategory optionCategory)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getOptionCategoryHttpResponse(Long id)
		throws Exception;

	public void patchOptionCategory(Long id, OptionCategory optionCategory)
		throws Exception;

	public HttpInvoker.HttpResponse patchOptionCategoryHttpResponse(
	...
	public static class OptionCategoryResourceImpl
		...
		public Page<OptionCategory> getOptionCategoriesPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getOptionCategoriesPageHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/optionCategories/export-batch");
		...
		public OptionCategory postOptionCategory(OptionCategory optionCategory)
			...
			HttpInvoker.HttpResponse httpResponse =
				postOptionCategoryHttpResponse(optionCategory);
		...
		public HttpInvoker.HttpResponse postOptionCategoryHttpResponse(
			...
			httpInvoker.body(optionCategory.toString(), "application/json");
		...
		public void postOptionCategoryBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postOptionCategoryBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/optionCategories/by-externalReferenceCode/{externalReferenceCode}");
		...
		public void deleteOptionCategory(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteOptionCategoryHttpResponse(id);
		...
		public HttpInvoker.HttpResponse deleteOptionCategoryHttpResponse(
				Long id)
			throws Exception {
		...
		public OptionCategory getOptionCategory(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getOptionCategoryHttpResponse(id);
		...
		public void patchOptionCategory(Long id, OptionCategory optionCategory)
			...
			HttpInvoker.HttpResponse httpResponse =
				patchOptionCategoryHttpResponse(id, optionCategory);
