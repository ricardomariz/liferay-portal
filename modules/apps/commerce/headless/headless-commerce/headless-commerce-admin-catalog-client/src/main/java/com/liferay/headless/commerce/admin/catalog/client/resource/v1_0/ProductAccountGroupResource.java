...
public interface ProductAccountGroupResource {
	...
	public HttpInvoker.HttpResponse deleteProductAccountGroupHttpResponse(
			Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getProductAccountGroupHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeProductAccountGroupsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getProductIdProductAccountGroupsPageHttpResponse(
				Long id, Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public ProductAccountGroupResource build() {
			return new ProductAccountGroupResourceImpl(this);
		}
	...
	public static class ProductAccountGroupResourceImpl
		implements ProductAccountGroupResource {

		public void deleteProductAccountGroup(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteProductAccountGroupHttpResponse(id);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/product-account-groups/{id}");
		...
		public ProductAccountGroup getProductAccountGroup(Long id)
			...
			HttpInvoker.HttpResponse httpResponse =
				getProductAccountGroupHttpResponse(id);
			...
			try {
				return ProductAccountGroupSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getProductAccountGroupHttpResponse(
				Long id)
			throws Exception {
		...
		public Page<ProductAccountGroup>
			...
			try {
				return Page.of(content, ProductAccountGroupSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/product-account-groups");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/product-account-groups");
		...
		private ProductAccountGroupResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ProductAccountGroupResource.class.getName());
