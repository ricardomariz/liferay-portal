...
public abstract class CommerceWishListLocalServiceBaseImpl
	...
	implements AopService, CommerceWishListLocalService,
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return commerceWishListPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return commerceWishListPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceWishListLocalServiceImpl#deleteCommerceWishList(CommerceWishList) to avoid orphaned data");
		}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CommerceWishListLocalService.class, IdentifiableOSGiService.class,
