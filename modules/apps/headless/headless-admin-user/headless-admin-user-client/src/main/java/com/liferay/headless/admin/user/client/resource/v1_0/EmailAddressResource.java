...
public interface EmailAddressResource {
	...
	public HttpInvoker.HttpResponse
			getAccountByExternalReferenceCodeEmailAddressesPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getAccountEmailAddressesPageHttpResponse(
			Long accountId)
		throws Exception;

	public void postAccountEmailAddressesPageExportBatch(
			Long accountId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postAccountEmailAddressesPageExportBatchHttpResponse(
				Long accountId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchEmailAddressByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, EmailAddress emailAddress)
		throws Exception;

	public void deleteEmailAddress(Long emailAddressId) throws Exception;

	public HttpInvoker.HttpResponse deleteEmailAddressHttpResponse(
			Long emailAddressId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchEmailAddressHttpResponse(
			Long emailAddressId, EmailAddress emailAddress)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrganizationByExternalReferenceCodeEmailAddressesPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public void postOrganizationEmailAddressesPageExportBatch(
			String organizationId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postOrganizationEmailAddressesPageExportBatchHttpResponse(
				String organizationId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getUserAccountByExternalReferenceCodeEmailAddressesPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public void postUserAccountEmailAddressesPageExportBatch(
			Long userAccountId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postUserAccountEmailAddressesPageExportBatchHttpResponse(
				Long userAccountId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class EmailAddressResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/accounts/by-external-reference-code/{externalReferenceCode}/email-addresses");
		...
		public Page<EmailAddress> getAccountEmailAddressesPage(Long accountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountEmailAddressesPageHttpResponse(accountId);
		...
		public HttpInvoker.HttpResponse
				getAccountEmailAddressesPageHttpResponse(Long accountId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/accounts/{accountId}/email-addresses");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/accounts/{accountId}/email-addresses/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/email-addresses/by-external-reference-code/{externalReferenceCode}");
		...
		public void deleteEmailAddress(Long emailAddressId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteEmailAddressHttpResponse(emailAddressId);
		...
		public HttpInvoker.HttpResponse deleteEmailAddressBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/email-addresses/batch");
		...
		public EmailAddress patchEmailAddress(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchEmailAddressHttpResponse(emailAddressId, emailAddress);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/organizations/by-external-reference-code/{externalReferenceCode}/email-addresses");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/organizations/{organizationId}/email-addresses/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/user-accounts/by-external-reference-code/{externalReferenceCode}/email-addresses");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/user-accounts/{userAccountId}/email-addresses/export-batch");
