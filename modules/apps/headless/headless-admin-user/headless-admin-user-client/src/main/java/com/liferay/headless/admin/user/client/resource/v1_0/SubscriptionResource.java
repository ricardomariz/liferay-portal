...
public interface SubscriptionResource {
	...
	public HttpInvoker.HttpResponse
			getMyUserAccountSubscriptionsPageHttpResponse(
				String contentType, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteMyUserAccountSubscriptionHttpResponse(
			Long subscriptionId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getMyUserAccountSubscriptionHttpResponse(
			Long subscriptionId)
		throws Exception;
	...
	public static class SubscriptionResourceImpl
		...
		public Page<Subscription> getMyUserAccountSubscriptionsPage(
			...
			try {
				return Page.of(content, SubscriptionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public void deleteMyUserAccountSubscription(Long subscriptionId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteMyUserAccountSubscriptionHttpResponse(subscriptionId);
		...
		public HttpInvoker.HttpResponse
				deleteMyUserAccountSubscriptionHttpResponse(Long subscriptionId)
			throws Exception {
		...
		public Subscription getMyUserAccountSubscription(Long subscriptionId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getMyUserAccountSubscriptionHttpResponse(subscriptionId);
			...
			try {
				return SubscriptionSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
				getMyUserAccountSubscriptionHttpResponse(Long subscriptionId)
			throws Exception {
		...
		private SubscriptionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SubscriptionResource.class.getName());
