...
public interface SegmentResource {
	...
	public void postSiteSegmentsPageExportBatch(
			Long siteId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postSiteSegmentsPageExportBatchHttpResponse(
			Long siteId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;
	...
	public static class SegmentResourceImpl implements SegmentResource {
		...
		public void postSiteSegmentsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteSegmentsPageExportBatchHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/sites/{siteId}/segments/export-batch");
