...
public interface WebUrlResource {
	...
	public HttpInvoker.HttpResponse
			getAccountByExternalReferenceCodeWebUrlsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;

	public Page<WebUrl> getAccountWebUrlsPage(Long accountId) throws Exception;

	public HttpInvoker.HttpResponse getAccountWebUrlsPageHttpResponse(
			Long accountId)
		throws Exception;

	public void postAccountWebUrlsPageExportBatch(
			Long accountId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postAccountWebUrlsPageExportBatchHttpResponse(
				Long accountId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrganizationByExternalReferenceCodeWebUrlsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public void postOrganizationWebUrlsPageExportBatch(
			String organizationId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postOrganizationWebUrlsPageExportBatchHttpResponse(
				String organizationId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getUserAccountByExternalReferenceCodeWebUrlsPageHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public void postUserAccountWebUrlsPageExportBatch(
			Long userAccountId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postUserAccountWebUrlsPageExportBatchHttpResponse(
				Long userAccountId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			deleteWebUrlByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getWebUrlByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchWebUrlByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, WebUrl webUrl)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchWebUrlHttpResponse(
			Long webUrlId, WebUrl webUrl)
		throws Exception;
	...
	public static class WebUrlResourceImpl implements WebUrlResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/accounts/by-external-reference-code/{externalReferenceCode}/web-urls");
		...
		public Page<WebUrl> getAccountWebUrlsPage(Long accountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountWebUrlsPageHttpResponse(accountId);
		...
		public HttpInvoker.HttpResponse getAccountWebUrlsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/accounts/{accountId}/web-urls");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/accounts/{accountId}/web-urls/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/organizations/by-external-reference-code/{externalReferenceCode}/web-urls");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/organizations/{organizationId}/web-urls/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/user-accounts/by-external-reference-code/{externalReferenceCode}/web-urls");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/user-accounts/{userAccountId}/web-urls/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/web-urls/by-external-reference-code/{externalReferenceCode}");
		...
		public WebUrl getWebUrlByExternalReferenceCode(
				String externalReferenceCode)
			throws Exception {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(webUrl.toString(), "application/json");
		...
		public void deleteWebUrl(Long webUrlId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteWebUrlHttpResponse(
				webUrlId);
		...
		public HttpInvoker.HttpResponse deleteWebUrlBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-user/v1.0/web-urls/batch");
		...
		public WebUrl patchWebUrl(Long webUrlId, WebUrl webUrl)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = patchWebUrlHttpResponse(
				webUrlId, webUrl);
