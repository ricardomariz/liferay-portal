 ...
 */
@Generated("")
@GraphQLName("AssetLibraryBrief")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AssetLibraryBrief")
public class AssetLibraryBrief implements Serializable {

	public static AssetLibraryBrief toDTO(String json) {
		return ObjectMapperUtil.readValue(AssetLibraryBrief.class, json);
	}

	public static AssetLibraryBrief unsafeToDTO(String json) {
