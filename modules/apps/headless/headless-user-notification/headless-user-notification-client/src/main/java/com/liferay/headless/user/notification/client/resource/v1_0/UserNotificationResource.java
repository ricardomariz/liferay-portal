...
public interface UserNotificationResource {
	...
	public Page<UserNotification> getUserAccountUserNotificationsPage(
			Long userAccountId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse
			getUserAccountUserNotificationsPageHttpResponse(
				Long userAccountId, String search, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getUserNotificationHttpResponse(
	...
	public HttpInvoker.HttpResponse putUserNotificationReadHttpResponse(
			Long userNotificationId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putUserNotificationUnreadHttpResponse(
			Long userNotificationId)
		throws Exception;
	...
	public static class UserNotificationResourceImpl
		...
		public Page<UserNotification> getUserAccountUserNotificationsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getUserAccountUserNotificationsPageHttpResponse(
					userAccountId, search, filterString, pagination,
					sortString);
		...
		public UserNotification getUserNotification(Long userNotificationId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getUserNotificationHttpResponse(userNotificationId);
		...
		public void putUserNotificationRead(Long userNotificationId)
			...
			HttpInvoker.HttpResponse httpResponse =
				putUserNotificationReadHttpResponse(userNotificationId);
		...
		public void putUserNotificationUnread(Long userNotificationId)
			...
			HttpInvoker.HttpResponse httpResponse =
				putUserNotificationUnreadHttpResponse(userNotificationId);
