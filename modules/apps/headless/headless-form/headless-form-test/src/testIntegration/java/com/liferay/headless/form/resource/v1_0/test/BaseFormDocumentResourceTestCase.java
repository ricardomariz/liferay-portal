...
public abstract class BaseFormDocumentResourceTestCase {
	...
	public void testVulcanCRUDItemDelegateGetItem() throws Exception {
		...
		VulcanCRUDItemDelegate vulcanCRUDItemDelegate =
			_vulcanCRUDItemDelegateBuilderRegistry.builder(
				testCompany, "com.liferay.headless.form.dto.v1_0.FormDocument"
			).acceptLanguage(
				new AcceptLanguage() {
		...
		Object item = vulcanCRUDItemDelegate.getItem(postFormDocument.getId());

		assertEquals(
			getFormDocument, FormDocumentSerDes.toDTO(item.toString()));
	}
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("contentUrl")) {
			Object object = formDocument.getContentUrl();
		...
		if (entityFieldName.equals("description")) {
			Object object = formDocument.getDescription();
		...
		if (entityFieldName.equals("encodingFormat")) {
			Object object = formDocument.getEncodingFormat();
		...
		if (entityFieldName.equals("fileExtension")) {
			Object object = formDocument.getFileExtension();
		...
		if (entityFieldName.equals("title")) {
			Object object = formDocument.getTitle();
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseFormDocumentResourceTestCase.class);
