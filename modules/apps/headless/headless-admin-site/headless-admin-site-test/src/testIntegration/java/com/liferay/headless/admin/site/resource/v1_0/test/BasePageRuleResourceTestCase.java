...
import com.liferay.headless.admin.site.client.resource.v1_0.PageRuleResource;
 ...
 */
@Generated("")
public abstract class BasePageRuleResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_pageRuleResource.setContextCompany(testCompany);

		com.liferay.portal.kernel.model.User testCompanyAdminUser =
			UserTestUtil.getAdminUser(testCompany.getCompanyId());

		pageRuleResource = PageRuleResource.builder(
		).authentication(
	...
	public void testClientSerDesToDTO() throws Exception {
		...
		PageRule pageRule1 = randomPageRule();

		String json = objectMapper.writeValueAsString(pageRule1);

		PageRule pageRule2 = PageRuleSerDes.toDTO(json);

		Assert.assertTrue(equals(pageRule1, pageRule2));
	}
	...
	public void testClientSerDesToJSON() throws Exception {
		...
		PageRule pageRule = randomPageRule();

		String json1 = objectMapper.writeValueAsString(pageRule);
		String json2 = PageRuleSerDes.toJSON(pageRule);
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		pageRule.setExternalReferenceCode(regex);
		pageRule.setName(regex);

		String json = PageRuleSerDes.toJSON(pageRule);

		Assert.assertFalse(json.contains(regex));

		pageRule = PageRuleSerDes.toDTO(json);

		Assert.assertEquals(regex, pageRule.getExternalReferenceCode());
		Assert.assertEquals(regex, pageRule.getName());
	}
	...
	public void testGetSiteSiteByExternalReferenceCodePageExperiencePageRulesPage()
		...
		assertContains(pageRule1, (List<PageRule>)page.getItems());
	...
	protected void assertContains(PageRule pageRule, List<PageRule> pageRules) {
		...
		for (PageRule item : pageRules) {
			if (equals(pageRule, item)) {
				contains = true;
		...
		Assert.assertTrue(
			pageRules + " does not contain " + pageRule, contains);
	}
	...
	protected void assertEquals(
		List<PageRule> pageRules1, List<PageRule> pageRules2) {

		Assert.assertEquals(pageRules1.size(), pageRules2.size());

		for (int i = 0; i < pageRules1.size(); i++) {
			PageRule pageRule1 = pageRules1.get(i);
			PageRule pageRule2 = pageRules2.get(i);

			assertEquals(pageRule1, pageRule2);
		}
	}
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (PageRule pageRule1 : pageRules1) {
			boolean contains = false;

			for (PageRule pageRule2 : pageRules2) {
				if (equals(pageRule1, pageRule2)) {
					contains = true;
			...
			Assert.assertTrue(
				pageRules2 + " does not contain " + pageRule1, contains);
		}
	}
	...
	protected void assertValid(Page<PageRule> page) {
		assertValid(page, Collections.emptyMap());
	}

	protected void assertValid(
		Page<PageRule> page, Map<String, Map<String, String>> expectedActions) {

		boolean valid = false;

		java.util.Collection<PageRule> pageRules = page.getItems();

		int size = pageRules.size();
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.admin.site.dto.v1_0.PageRule.class)) {
	...
	protected java.util.Collection<EntityField> getEntityFields()
		...
		if (!(_pageRuleResource instanceof EntityModelResource)) {
			throw new UnsupportedOperationException(
				"Resource is not an instance of EntityModelResource");
		}

		EntityModelResource entityModelResource =
			(EntityModelResource)_pageRuleResource;
	...
	protected String getFilterString(
		EntityField entityField, String operator, PageRule pageRule) {
		...
		if (entityFieldName.equals("conditionType")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}

		if (entityFieldName.equals("externalReferenceCode")) {
			Object object = pageRule.getExternalReferenceCode();
		...
		if (entityFieldName.equals("name")) {
			Object object = pageRule.getName();
		...
		if (entityFieldName.equals("pageRuleActions")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}

		if (entityFieldName.equals("pageRuleConditions")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
	...
	protected PageRule randomIrrelevantPageRule() throws Exception {
		PageRule randomIrrelevantPageRule = randomPageRule();

		return randomIrrelevantPageRule;
	}

	protected PageRule randomPatchPageRule() throws Exception {
		return randomPageRule();
	}

	protected PageRuleResource pageRuleResource;
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BasePageRuleResourceTestCase.class);

	private static DateFormat _dateFormat;

	@Inject
	private com.liferay.headless.admin.site.resource.v1_0.PageRuleResource
		_pageRuleResource;
