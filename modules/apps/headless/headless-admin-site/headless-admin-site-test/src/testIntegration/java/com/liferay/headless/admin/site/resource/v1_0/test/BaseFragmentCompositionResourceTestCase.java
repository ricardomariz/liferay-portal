	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("dateCreated")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(fragmentComposition.getDateCreated()));
			}
		...
		if (entityFieldName.equals("dateModified")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(fragmentComposition.getDateModified()));
			}
		...
		if (entityFieldName.equals("datePublished")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(fragmentComposition.getDatePublished()));
			}
