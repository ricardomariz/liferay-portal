...
public interface WorkflowTaskTransitionsResource {
	...
	public static class Builder {
		...
		public WorkflowTaskTransitionsResource build() {
			return new WorkflowTaskTransitionsResourceImpl(this);
		}
	...
	public static class WorkflowTaskTransitionsResourceImpl
		...
		private WorkflowTaskTransitionsResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			WorkflowTaskTransitionsResource.class.getName());
