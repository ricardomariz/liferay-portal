...
public interface WorkflowDefinitionLinkResource {
	...
	public HttpInvoker.HttpResponse
			getWorkflowDefinitionWorkflowDefinitionLinksPageHttpResponse(
				Long workflowDefinitionId, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postWorkflowDefinitionWorkflowDefinitionLinkHttpResponse(
				Long workflowDefinitionId,
				WorkflowDefinitionLink workflowDefinitionLink)
		throws Exception;
	...
	public static class Builder {
		...
		public WorkflowDefinitionLinkResource build() {
			return new WorkflowDefinitionLinkResourceImpl(this);
		}
	...
	public static class WorkflowDefinitionLinkResourceImpl
		...
		public Page<WorkflowDefinitionLink>
			...
			try {
				return Page.of(content, WorkflowDefinitionLinkSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<WorkflowDefinitionLink>
			...
			HttpInvoker.HttpResponse httpResponse =
				getWorkflowDefinitionWorkflowDefinitionLinksPageHttpResponse(
					workflowDefinitionId, pagination);
		...
		private WorkflowDefinitionLinkResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			WorkflowDefinitionLinkResource.class.getName());
