 ...
 */
@Generated("")
public interface ContentTemplateResource {
	...
	public void postAssetLibraryContentTemplatesPageExportBatch(
	...
	public HttpInvoker.HttpResponse
			postAssetLibraryContentTemplatesPageExportBatchHttpResponse(
				Long assetLibraryId, String search, String filterString,
				String sortString, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public ContentTemplateResource build() {
	...
	public static class ContentTemplateResourceImpl
		...
		public Page<ContentTemplate> getAssetLibraryContentTemplatesPage(
			...
			try {
				return Page.of(content, ContentTemplateSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public ContentTemplate getSiteContentTemplate(
			...
			try {
				return ContentTemplateSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private ContentTemplateResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ContentTemplateResource.class.getName());
