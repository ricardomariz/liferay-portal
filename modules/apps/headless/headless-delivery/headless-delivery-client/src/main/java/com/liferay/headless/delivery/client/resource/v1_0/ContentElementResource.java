...
public interface ContentElementResource {
	...
	public HttpInvoker.HttpResponse
			getAssetLibraryContentElementsPageHttpResponse(
				Long assetLibraryId, String search, List<String> aggregations,
				String filterString, Pagination pagination, String sortString)
		throws Exception;

	public void postAssetLibraryContentElementsPageExportBatch(
	...
	public static class Builder {
		...
		public ContentElementResource build() {
			return new ContentElementResourceImpl(this);
		}
	...
	public static class ContentElementResourceImpl
		implements ContentElementResource {
		...
		public Page<ContentElement> getAssetLibraryContentElementsPage(
			...
			try {
				return Page.of(content, ContentElementSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<ContentElement> getSiteContentElementsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteContentElementsPageHttpResponse(
		...
		private ContentElementResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ContentElementResource.class.getName());
