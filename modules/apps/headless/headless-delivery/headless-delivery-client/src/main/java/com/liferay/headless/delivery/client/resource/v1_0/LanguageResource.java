...
public interface LanguageResource {
	...
	public HttpInvoker.HttpResponse getAssetLibraryLanguagesPageHttpResponse(
			Long assetLibraryId)
		throws Exception;
	...
	public static class Builder {
		...
		public LanguageResource build() {
			return new LanguageResourceImpl(this);
		}
	...
	public static class LanguageResourceImpl implements LanguageResource {
		...
		public Page<Language> getAssetLibraryLanguagesPage(Long assetLibraryId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getAssetLibraryLanguagesPageHttpResponse(assetLibraryId);
		...
		public HttpInvoker.HttpResponse
				getAssetLibraryLanguagesPageHttpResponse(Long assetLibraryId)
			throws Exception {
		...
		public Page<Language> getSiteLanguagesPage(Long siteId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteLanguagesPageHttpResponse(siteId);
		...
		private LanguageResourceImpl(Builder builder) {
			_builder = builder;
		}
