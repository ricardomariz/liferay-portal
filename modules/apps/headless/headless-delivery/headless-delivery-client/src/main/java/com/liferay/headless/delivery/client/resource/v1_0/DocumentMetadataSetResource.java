...
public interface DocumentMetadataSetResource {
	...
	public HttpInvoker.HttpResponse
			getAssetLibraryDocumentMetadataSetsPageHttpResponse(
				Long assetLibraryId, Pagination pagination)
		throws Exception;

	public void postAssetLibraryDocumentMetadataSetsPageExportBatch(
			Long assetLibraryId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postAssetLibraryDocumentMetadataSetsPageExportBatchHttpResponse(
				Long assetLibraryId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteDocumentMetadataSetHttpResponse(
	...
	public HttpInvoker.HttpResponse getDocumentMetadataSetHttpResponse(
			Long documentMetadataSetId)
		throws Exception;
	...
	public static class Builder {
		...
		public DocumentMetadataSetResource build() {
			return new DocumentMetadataSetResourceImpl(this);
		}
	...
	public static class DocumentMetadataSetResourceImpl
		implements DocumentMetadataSetResource {

		public Page<DocumentMetadataSet>
			...
			try {
				return Page.of(content, DocumentMetadataSetSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public void deleteDocumentMetadataSet(Long documentMetadataSetId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteDocumentMetadataSetHttpResponse(documentMetadataSetId);
		...
		public DocumentMetadataSet getDocumentMetadataSet(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDocumentMetadataSetHttpResponse(documentMetadataSetId);
		...
		public Page<DocumentMetadataSet> getSiteDocumentMetadataSetsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteDocumentMetadataSetsPageHttpResponse(siteId, pagination);
		...
		private DocumentMetadataSetResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DocumentMetadataSetResource.class.getName());
