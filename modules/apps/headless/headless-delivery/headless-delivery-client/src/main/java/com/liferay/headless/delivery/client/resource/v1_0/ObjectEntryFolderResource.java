...
public interface ObjectEntryFolderResource {
	...
	public HttpInvoker.HttpResponse
			getAssetLibraryObjectEntryFoldersPageHttpResponse(
				Long assetLibraryId, Boolean flatten, String search,
				List<String> aggregations, String filterString,
				Pagination pagination, String sortString)
		throws Exception;

	public void postAssetLibraryObjectEntryFoldersPageExportBatch(
	...
	public HttpInvoker.HttpResponse
			postAssetLibraryObjectEntryFoldersPageExportBatchHttpResponse(
				Long assetLibraryId, String search, String filterString,
				String sortString, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postAssetLibraryObjectEntryFolderHttpResponse(
				Long assetLibraryId, ObjectEntryFolder objectEntryFolder)
		throws Exception;

	public void postAssetLibraryObjectEntryFolderBatch(
			Long assetLibraryId, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse
			postAssetLibraryObjectEntryFolderBatchHttpResponse(
				Long assetLibraryId, String callbackURL, Object object)
		throws Exception;
	...
	public static class Builder {
		...
		public ObjectEntryFolderResource build() {
			return new ObjectEntryFolderResourceImpl(this);
		}
	...
	public static class ObjectEntryFolderResourceImpl
		implements ObjectEntryFolderResource {
		...
		public Page<ObjectEntryFolder> getAssetLibraryObjectEntryFoldersPage(
			...
			try {
				return Page.of(content, ObjectEntryFolderSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/asset-libraries/{assetLibraryId}/object-entry-folders");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/asset-libraries/{assetLibraryId}/object-entry-folders/export-batch");
		...
		private ObjectEntryFolderResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ObjectEntryFolderResource.class.getName());
