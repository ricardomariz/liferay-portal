...
public interface DocumentShortcutResource {
	...
	public HttpInvoker.HttpResponse deleteDocumentShortcutHttpResponse(
	...
	public static class DocumentShortcutResourceImpl
		...
		public void deleteDocumentShortcut(Long documentShortcutId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteDocumentShortcutHttpResponse(documentShortcutId);
		...
		public DocumentShortcut putSiteDocumentShortcutByExternalReferenceCode(
			...
			HttpInvoker.HttpResponse httpResponse =
				putSiteDocumentShortcutByExternalReferenceCodeHttpResponse(
					siteId, externalReferenceCode, documentShortcut);
