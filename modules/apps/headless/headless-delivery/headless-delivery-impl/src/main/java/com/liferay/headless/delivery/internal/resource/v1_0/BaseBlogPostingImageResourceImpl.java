...
public abstract class BaseBlogPostingImageResourceImpl
	implements BlogPostingImageResource, EntityModelResource,
			   ...
			   VulcanCRUDItemDelegate<BlogPostingImage> {
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/sites/{siteId}/blog-posting-images/export-batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postSiteBlogPostingImagesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				BlogPostingImage.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	@Override
	public BlogPostingImage getItem(Long id) throws Exception {
		return getBlogPostingImage(id);
	}
	...
	private class PostSiteBlogPostingImageRequestBody {
