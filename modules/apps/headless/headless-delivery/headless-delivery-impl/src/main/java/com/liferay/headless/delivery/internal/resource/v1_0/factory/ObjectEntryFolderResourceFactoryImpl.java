...
@Generated("")
public class ObjectEntryFolderResourceFactoryImpl
	implements ObjectEntryFolderResource.Factory {

	@Override
	public ObjectEntryFolderResource.Builder create() {
		return new ObjectEntryFolderResource.Builder() {
			...
			public ObjectEntryFolderResource build() {
				...
				Function<InvocationHandler, ObjectEntryFolderResource>
					objectEntryFolderResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_objectEntryFolderResourceProxyProviderFunction;

				return objectEntryFolderResourceProxyProviderFunction.apply(
			...
			@Override
			public ObjectEntryFolderResource.Builder checkPermissions(
			...
			@Override
			public ObjectEntryFolderResource.Builder httpServletRequest(
			...
			@Override
			public ObjectEntryFolderResource.Builder httpServletResponse(
			...
			@Override
			public ObjectEntryFolderResource.Builder preferredLocale(
			...
			@Override
			public ObjectEntryFolderResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public ObjectEntryFolderResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ObjectEntryFolderResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ObjectEntryFolderResource.class.getClassLoader(),
			ObjectEntryFolderResource.class);

		try {
			Constructor<ObjectEntryFolderResource> constructor =
				(Constructor<ObjectEntryFolderResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(objectEntryFolderResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ObjectEntryFolderResource>
				_objectEntryFolderResourceProxyProviderFunction =
					_getProxyProviderFunction();
