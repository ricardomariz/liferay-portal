 ...
 */
@Generated("")
public abstract class BasePageDefinitionResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_pageDefinitionResource.setContextCompany(testCompany);

		com.liferay.portal.kernel.model.User testCompanyAdminUser =
			UserTestUtil.getAdminUser(testCompany.getCompanyId());

		pageDefinitionResource = PageDefinitionResource.builder(
		).authentication(
	...
	public void testClientSerDesToDTO() throws Exception {
		...
		PageDefinition pageDefinition1 = randomPageDefinition();

		String json = objectMapper.writeValueAsString(pageDefinition1);

		PageDefinition pageDefinition2 = PageDefinitionSerDes.toDTO(json);

		Assert.assertTrue(equals(pageDefinition1, pageDefinition2));
	}
	...
	public void testClientSerDesToJSON() throws Exception {
		...
		PageDefinition pageDefinition = randomPageDefinition();

		String json1 = objectMapper.writeValueAsString(pageDefinition);
		String json2 = PageDefinitionSerDes.toJSON(pageDefinition);
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		String json = PageDefinitionSerDes.toJSON(pageDefinition);

		Assert.assertFalse(json.contains(regex));

		pageDefinition = PageDefinitionSerDes.toDTO(json);
	}
	...
	protected void assertEquals(
		PageDefinition pageDefinition1, PageDefinition pageDefinition2) {

		Assert.assertTrue(
			pageDefinition1 + " does not equal " + pageDefinition2,
			equals(pageDefinition1, pageDefinition2));
	}
	...
	protected void assertEquals(
		...
		Assert.assertEquals(pageDefinitions1.size(), pageDefinitions2.size());

		for (int i = 0; i < pageDefinitions1.size(); i++) {
			PageDefinition pageDefinition1 = pageDefinitions1.get(i);
			PageDefinition pageDefinition2 = pageDefinitions2.get(i);

			assertEquals(pageDefinition1, pageDefinition2);
		}
	}
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (PageDefinition pageDefinition1 : pageDefinitions1) {
			boolean contains = false;

			for (PageDefinition pageDefinition2 : pageDefinitions2) {
				if (equals(pageDefinition1, pageDefinition2)) {
					contains = true;
			...
			Assert.assertTrue(
				pageDefinitions2 + " does not contain " + pageDefinition1,
				contains);
		}
	}
	...
	protected void assertValid(Page<PageDefinition> page) {
	...
	protected void assertValid(
		...
		java.util.Collection<PageDefinition> pageDefinitions = page.getItems();

		int size = pageDefinitions.size();
	...
	protected boolean equals(
		...
		if (pageDefinition1 == pageDefinition2) {
			return true;
		}
	...
	protected java.util.Collection<EntityField> getEntityFields()
		...
		if (!(_pageDefinitionResource instanceof EntityModelResource)) {
			throw new UnsupportedOperationException(
				"Resource is not an instance of EntityModelResource");
		}

		EntityModelResource entityModelResource =
			(EntityModelResource)_pageDefinitionResource;
	...
	protected PageDefinition randomIrrelevantPageDefinition() throws Exception {
		PageDefinition randomIrrelevantPageDefinition = randomPageDefinition();

		return randomIrrelevantPageDefinition;
	}

	protected PageDefinition randomPatchPageDefinition() throws Exception {
		return randomPageDefinition();
	}

	protected PageDefinitionResource pageDefinitionResource;
