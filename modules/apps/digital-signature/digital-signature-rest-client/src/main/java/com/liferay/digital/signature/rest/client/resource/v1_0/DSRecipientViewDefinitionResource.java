...
public interface DSRecipientViewDefinitionResource {
	...
	public HttpInvoker.HttpResponse
			postSiteDSRecipientViewDefinitionHttpResponse(
				Long siteId, String dsEnvelopeId,
				DSRecipientViewDefinition dsRecipientViewDefinition)
		throws Exception;
	...
	public static class Builder {
		...
		public DSRecipientViewDefinitionResource build() {
			return new DSRecipientViewDefinitionResourceImpl(this);
		}
	...
	public static class DSRecipientViewDefinitionResourceImpl
		...
		public DSEnvelopeSignatureURL postSiteDSRecipientViewDefinition(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteDSRecipientViewDefinitionHttpResponse(
					siteId, dsEnvelopeId, dsRecipientViewDefinition);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				dsRecipientViewDefinition.toString(), "application/json");
		...
		private DSRecipientViewDefinitionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DSRecipientViewDefinitionResource.class.getName());
