...
import com.liferay.portal.language.rest.client.resource.v1_0.MessageResource;
...
public abstract class BaseMessageResourceTestCase {
	...
	public void testPostMessage() throws Exception {
		...
		Message postMessage = testPostMessage_addMessage(randomMessage);

		assertEquals(randomMessage, postMessage);
		assertValid(postMessage);
	}

	protected Message testPostMessage_addMessage(Message message)
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.portal.language.rest.dto.v1_0.Message.class)) {
	...
	@Inject
	private com.liferay.portal.language.rest.resource.v1_0.MessageResource
		_messageResource;
