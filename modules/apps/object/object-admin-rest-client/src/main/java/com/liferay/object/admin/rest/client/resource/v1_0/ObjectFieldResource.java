...
public interface ObjectFieldResource {
	...
	public void postObjectDefinitionObjectFieldsPageExportBatch(
			Long objectDefinitionId, String search, String filterString,
	...
	public HttpInvoker.HttpResponse
			postObjectDefinitionObjectFieldsPageExportBatchHttpResponse(
				Long objectDefinitionId, String search, String filterString,
				String sortString, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postObjectDefinitionObjectFieldHttpResponse(
			Long objectDefinitionId, ObjectField objectField)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteObjectFieldHttpResponse(
			Long objectFieldId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putObjectFieldHttpResponse(
			Long objectFieldId, ObjectField objectField)
		throws Exception;
	...
	public static class Builder {
		...
		public ObjectFieldResource build() {
	...
	public static class ObjectFieldResourceImpl implements ObjectFieldResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-admin/v1.0/object-definitions/{objectDefinitionId}/object-fields/export-batch");
		...
		public ObjectField postObjectDefinitionObjectField(
			...
			HttpInvoker.HttpResponse httpResponse =
				postObjectDefinitionObjectFieldHttpResponse(
		...
		public void deleteObjectField(Long objectFieldId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteObjectFieldHttpResponse(objectFieldId);
		...
		public ObjectField getObjectField(Long objectFieldId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getObjectFieldHttpResponse(
				objectFieldId);
		...
		public ObjectField putObjectField(
			...
			HttpInvoker.HttpResponse httpResponse = putObjectFieldHttpResponse(
		...
		private ObjectFieldResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ObjectFieldResource.class.getName());
