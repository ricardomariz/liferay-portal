...
public interface ObjectRelationshipResource {
	...
	public HttpInvoker.HttpResponse
			putObjectRelationshipByExternalReferenceCodeHttpResponse(
				String externalReferenceCode,
				ObjectRelationship objectRelationship)
		throws Exception;
	...
	public static class ObjectRelationshipResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-admin/v1.0/object-definitions/{objectDefinitionId}/object-relationships/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-admin/v1.0/object-relationships/by-external-reference-code/{externalReferenceCode}");
