...
public interface ObjectActionResource {
	...
	public HttpInvoker.HttpResponse deleteObjectActionHttpResponse(
			Long objectActionId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getObjectActionHttpResponse(
			Long objectActionId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchObjectActionHttpResponse(
			Long objectActionId, ObjectAction objectAction)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putObjectActionHttpResponse(
			Long objectActionId, ObjectAction objectAction)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postObjectDefinitionByExternalReferenceCodeObjectActionHttpResponse(
				String externalReferenceCode, ObjectAction objectAction)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postObjectDefinitionObjectActionHttpResponse(
				Long objectDefinitionId, ObjectAction objectAction)
		throws Exception;
	...
	public static class ObjectActionResourceImpl
		implements ObjectActionResource {

		public void deleteObjectAction(Long objectActionId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteObjectActionHttpResponse(objectActionId);
		...
		public ObjectAction getObjectAction(Long objectActionId)
			...
			HttpInvoker.HttpResponse httpResponse = getObjectActionHttpResponse(
				objectActionId);
			...
			try {
				return ObjectActionSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public ObjectAction patchObjectAction(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchObjectActionHttpResponse(objectActionId, objectAction);
		...
		public HttpInvoker.HttpResponse patchObjectActionHttpResponse(
			...
			httpInvoker.body(objectAction.toString(), "application/json");
		...
		public ObjectAction putObjectAction(
			...
			HttpInvoker.HttpResponse httpResponse = putObjectActionHttpResponse(
		...
		public Page<ObjectAction>
			...
			try {
				return Page.of(content, ObjectActionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-admin/v1.0/object-definitions/by-external-reference-code/{externalReferenceCode}/object-actions");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-admin/v1.0/object-definitions/{objectDefinitionId}/object-actions/export-batch");
		...
		private ObjectActionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ObjectActionResource.class.getName());
