...
export class ObjectFolderApi {
	...
	public async deleteObjectFolder (objectFolderId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any; }> {
		const localVarPath = this.basePath + '/object-admin/v1.0/object-folders/{objectFolderId}'.replace('{' + 'objectFolderId' + '}', encodeURIComponent(String(objectFolderId)));
	...
	public async getObjectFolderByExternalReferenceCode (externalReferenceCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectFolder; }> {
		const localVarPath = this.basePath + '/object-admin/v1.0/object-folders/by-external-reference-code/{externalReferenceCode}'.replace('{' + 'externalReferenceCode' + '}', encodeURIComponent(String(externalReferenceCode)));
		let localVarQueryParameters: any = {};
		let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
		const produces = ['application/json', 'application/xml'];
		// give precedence to 'application/json'
