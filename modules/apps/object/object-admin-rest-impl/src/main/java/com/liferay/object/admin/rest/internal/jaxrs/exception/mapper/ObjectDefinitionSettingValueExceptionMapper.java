...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Object.Admin.REST.ObjectDefinitionSettingValueExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class ObjectDefinitionSettingValueExceptionMapper
	extends BaseExceptionMapper<ObjectDefinitionSettingValueException> {
