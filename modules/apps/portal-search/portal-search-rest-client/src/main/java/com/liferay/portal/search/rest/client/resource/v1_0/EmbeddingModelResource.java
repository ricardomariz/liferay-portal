 ...
 */
@Generated("")
public interface EmbeddingModelResource {
	...
	public HttpInvoker.HttpResponse getEmbeddingEmbeddingModelsPageHttpResponse(
			String provider, String search, Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public EmbeddingModelResource build() {
			return new EmbeddingModelResourceImpl(this);
		}
	...
	public static class EmbeddingModelResourceImpl
		implements EmbeddingModelResource {
		...
		public Page<EmbeddingModel> getEmbeddingEmbeddingModelsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getEmbeddingEmbeddingModelsPageHttpResponse(
			...
			try {
				return Page.of(content, EmbeddingModelSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			if (provider != null) {
				httpInvoker.parameter("provider", String.valueOf(provider));
			}
		...
		private EmbeddingModelResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			EmbeddingModelResource.class.getName());
