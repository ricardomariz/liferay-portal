 ...
 */
@Generated("")
public abstract class BaseEntityModelResourceTestEntity2ResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_entityModelResourceTestEntity2Resource.setContextCompany(testCompany);

		com.liferay.portal.kernel.model.User testCompanyAdminUser =
			UserTestUtil.getAdminUser(testCompany.getCompanyId());

		entityModelResourceTestEntity2Resource =
			EntityModelResourceTestEntity2Resource.builder(
			).authentication(
	...
	public void testClientSerDesToJSON() throws Exception {
		...
		String json2 = EntityModelResourceTestEntity2SerDes.toJSON(
			entityModelResourceTestEntity2);
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		entityModelResourceTestEntity2.setName(regex);

		String json = EntityModelResourceTestEntity2SerDes.toJSON(
			entityModelResourceTestEntity2);
		...
		Assert.assertEquals(regex, entityModelResourceTestEntity2.getName());
	}
	...
	public void testGetEntityModelResourceTestEntities2EntityModelResourceTestEntity2()
		...
		assertEquals(
			postEntityModelResourceTestEntity2,
	...
	protected void assertEquals(
		...
		Assert.assertTrue(
			entityModelResourceTestEntity21 + " does not equal " +
				entityModelResourceTestEntity22,
			equals(
				entityModelResourceTestEntity21,
				entityModelResourceTestEntity22));
	...
	protected void assertValid(Page<EntityModelResourceTestEntity2> page) {
		assertValid(page, Collections.emptyMap());
	}

	protected void assertValid(
		Page<EntityModelResourceTestEntity2> page,
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.portal.tools.rest.builder.test.dto.v1_0.
						EntityModelResourceTestEntity2.class)) {
	...
	protected boolean equals(
		...
		if (entityModelResourceTestEntity21 ==
				entityModelResourceTestEntity22) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("id", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						entityModelResourceTestEntity21.getId(),
						entityModelResourceTestEntity22.getId())) {
			...
			if (Objects.equals("name", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						entityModelResourceTestEntity21.getName(),
						entityModelResourceTestEntity22.getName())) {
	...
	protected java.util.Collection<EntityField> getEntityFields()
		...
		if (!(_entityModelResourceTestEntity2Resource instanceof
				EntityModelResource)) {
		...
		EntityModelResource entityModelResource =
			(EntityModelResource)_entityModelResourceTestEntity2Resource;
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("name")) {
			Object object = entityModelResourceTestEntity2.getName();
	...
	protected EntityModelResourceTestEntity2
			randomIrrelevantEntityModelResourceTestEntity2()
		throws Exception {
		...
		return randomIrrelevantEntityModelResourceTestEntity2;
	}

	protected EntityModelResourceTestEntity2
			randomPatchEntityModelResourceTestEntity2()
		throws Exception {

		return randomEntityModelResourceTestEntity2();
	}

	protected EntityModelResourceTestEntity2Resource
		entityModelResourceTestEntity2Resource;
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseEntityModelResourceTestEntity2ResourceTestCase.class);
