...
public class RESTBuilder {
		...
		for (File openAPIYAMLFile : openAPIYAMLFiles) {
			...
			if (_configYAML.isGenerateClientJS() &&
				...
				TypeScriptClientUtil.generateTypeScriptClient(
					_prepareForClientJSGenerator(yamlString), _configDir,
					_copyrightFile);
			}
		}
	...
	private OpenAPIYAML _prepareForClientJSGenerator(String openAPIYAMLString)
		throws Exception {
		...
		return _loadOpenAPIYAML(modifiedYAML.toString());
	}
