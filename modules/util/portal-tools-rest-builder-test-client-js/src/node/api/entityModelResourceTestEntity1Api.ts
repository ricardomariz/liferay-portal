...
export class EntityModelResourceTestEntity1Api {
	 ...
	 */
	public async getEntityModelResourceTestEntities1Page (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PageEntityModelResourceTestEntity1; }> {
		...
		return interceptorPromise.then(() => {
			...
			return new Promise<{ response: http.IncomingMessage; body: PageEntityModelResourceTestEntity1; }>((resolve, reject) => {
