...
public interface EntityModelResourceTestEntity1Resource {
	...
	public static class Builder {
		...
		public EntityModelResourceTestEntity1Resource build() {
			return new EntityModelResourceTestEntity1ResourceImpl(this);
		}
	...
	public static class EntityModelResourceTestEntity1ResourceImpl
		implements EntityModelResourceTestEntity1Resource {
		...
		public Page<EntityModelResourceTestEntity1>
			...
			try {
				return Page.of(
					content, EntityModelResourceTestEntity1SerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private static final Logger _logger = Logger.getLogger(
			EntityModelResourceTestEntity1Resource.class.getName());
