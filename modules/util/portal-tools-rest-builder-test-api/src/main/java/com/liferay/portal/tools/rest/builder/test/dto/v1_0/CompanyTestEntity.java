 ...
 */
@Generated("")
@GraphQLName("CompanyTestEntity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CompanyTestEntity")
public class CompanyTestEntity implements Serializable {

	public static CompanyTestEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(CompanyTestEntity.class, json);
	}

	public static CompanyTestEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(CompanyTestEntity.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.portal.tools.rest.builder.test.dto.v1_0.CompanyTestEntity",
		name = "x-class-name"
	)
