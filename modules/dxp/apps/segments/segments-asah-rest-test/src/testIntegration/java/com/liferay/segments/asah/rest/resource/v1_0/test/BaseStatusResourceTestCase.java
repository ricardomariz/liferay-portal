...
public abstract class BaseStatusResourceTestCase {
	...
	protected void assertValid(
		Page<Status> page, Map<String, Map<String, String>> expectedActions) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.segments.asah.rest.dto.v1_0.Status.class)) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("status")) {
			Object object = status.getStatus();
		...
		if (entityFieldName.equals("winnerVariantId")) {
			Object object = status.getWinnerVariantId();
