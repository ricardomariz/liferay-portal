...
public interface GroupResource {
	...
	public HttpInvoker.HttpResponse postV2GroupHttpResponse(Group group)
		throws Exception;

	public void postV2GroupSearch(QueryAttributes queryAttributes)
		throws Exception;

	public HttpInvoker.HttpResponse postV2GroupSearchHttpResponse(
			QueryAttributes queryAttributes)
		throws Exception;

	public void deleteV2Group(String id) throws Exception;
	...
	public HttpInvoker.HttpResponse putV2GroupHttpResponse(
	...
	public static class GroupResourceImpl implements GroupResource {
		...
		public void postV2Group(Group group) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postV2GroupHttpResponse(
				group);
		...
		public HttpInvoker.HttpResponse postV2GroupHttpResponse(Group group)
			...
			httpInvoker.body(group.toString(), "application/scim+json");
		...
		public void postV2GroupSearch(QueryAttributes queryAttributes)
			...
			HttpInvoker.HttpResponse httpResponse =
				postV2GroupSearchHttpResponse(queryAttributes);
		...
		public void deleteV2Group(String id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteV2GroupHttpResponse(
				id);
		...
		public void putV2Group(String id, Group group) throws Exception {
			HttpInvoker.HttpResponse httpResponse = putV2GroupHttpResponse(
				id, group);
