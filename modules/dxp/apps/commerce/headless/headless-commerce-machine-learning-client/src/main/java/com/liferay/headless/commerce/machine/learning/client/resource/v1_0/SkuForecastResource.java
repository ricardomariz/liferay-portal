...
public interface SkuForecastResource {
	...
	public HttpInvoker.HttpResponse
			getSkuForecastsByMonthlyRevenuePageHttpResponse(
				Integer forecastLength, java.util.Date forecastStartDate,
				Integer historyLength, String[] skus, Pagination pagination)
		throws Exception;
	...
	public static class SkuForecastResourceImpl implements SkuForecastResource {
		...
		private static final Logger _logger = Logger.getLogger(
			SkuForecastResource.class.getName());
