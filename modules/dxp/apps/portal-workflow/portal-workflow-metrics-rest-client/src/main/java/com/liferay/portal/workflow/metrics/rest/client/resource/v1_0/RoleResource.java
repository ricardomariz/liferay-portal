...
public interface RoleResource {
	...
	public void postProcessRolesPageExportBatch(
			Long processId, Boolean completed, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postProcessRolesPageExportBatchHttpResponse(
			Long processId, Boolean completed, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;
	...
	public static class RoleResourceImpl implements RoleResource {
		...
		public void postProcessRolesPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProcessRolesPageExportBatchHttpResponse(
