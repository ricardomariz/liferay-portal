 ...
 */
@Generated("")
public interface ProcessVersionResource {
	...
	public void postProcessProcessVersionsPageExportBatch(
			Long processId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postProcessProcessVersionsPageExportBatchHttpResponse(
				Long processId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public ProcessVersionResource build() {
			return new ProcessVersionResourceImpl(this);
		}
	...
	public static class ProcessVersionResourceImpl
		...
		public Page<ProcessVersion> getProcessProcessVersionsPage(
			...
			try {
				return Page.of(content, ProcessVersionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private ProcessVersionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ProcessVersionResource.class.getName());
