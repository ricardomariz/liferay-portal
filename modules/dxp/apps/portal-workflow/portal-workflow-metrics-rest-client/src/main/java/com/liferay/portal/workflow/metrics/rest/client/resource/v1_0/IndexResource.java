...
public interface IndexResource {
	...
	public void postIndexesPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postIndexesPageExportBatchHttpResponse(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class IndexResourceImpl implements IndexResource {

		public Page<Index> getIndexesPage() throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getIndexesPageHttpResponse();
		...
		public void postIndexesPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postIndexesPageExportBatchHttpResponse(
		...
		public HttpInvoker.HttpResponse patchIndexRefreshHttpResponse(
			...
			httpInvoker.body(index.toString(), "application/json");
		...
		private IndexResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			IndexResource.class.getName());
