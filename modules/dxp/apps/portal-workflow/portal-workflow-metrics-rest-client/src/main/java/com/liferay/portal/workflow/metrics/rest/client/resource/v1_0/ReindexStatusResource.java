 ...
 */
@Generated("")
public interface ReindexStatusResource {
	...
	public void postReindexStatusesPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postReindexStatusesPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class ReindexStatusResourceImpl
		...
		private ReindexStatusResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ReindexStatusResource.class.getName());
