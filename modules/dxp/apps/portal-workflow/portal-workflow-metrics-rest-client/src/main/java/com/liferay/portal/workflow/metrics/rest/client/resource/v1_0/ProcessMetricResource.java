...
public interface ProcessMetricResource {
	...
	public void postProcessMetricsPageExportBatch(
			String title, String sortString, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postProcessMetricsPageExportBatchHttpResponse(
				String title, String sortString, String callbackURL,
				String contentType, String fieldNames)
		throws Exception;
	...
	public static class ProcessMetricResourceImpl
		...
		public void postProcessMetricsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProcessMetricsPageExportBatchHttpResponse(
					title, sortString, callbackURL, contentType, fieldNames);
