...
public interface NodeMetricResource {
	...
	public static class NodeMetricResourceImpl implements NodeMetricResource {
		...
		private NodeMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			NodeMetricResource.class.getName());
