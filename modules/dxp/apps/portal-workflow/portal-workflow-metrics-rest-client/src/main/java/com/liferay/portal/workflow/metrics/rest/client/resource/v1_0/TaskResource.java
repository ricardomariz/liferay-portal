...
public interface TaskResource {
	...
	public void postProcessTasksPageExportBatch(
			Long processId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postProcessTasksPageExportBatchHttpResponse(
			Long processId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;
	...
	public static class TaskResourceImpl implements TaskResource {
		...
		public void postProcessTasksPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProcessTasksPageExportBatchHttpResponse(
