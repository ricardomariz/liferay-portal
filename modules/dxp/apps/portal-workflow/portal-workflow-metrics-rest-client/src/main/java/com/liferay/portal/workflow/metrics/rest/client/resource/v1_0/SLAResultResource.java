...
public interface SLAResultResource {
	...
	public HttpInvoker.HttpResponse getProcessLastSLAResultHttpResponse(
			Long processId)
		throws Exception;
	...
	public static class Builder {
		...
		public SLAResultResource build() {
			return new SLAResultResourceImpl(this);
		}
	...
	public static class SLAResultResourceImpl implements SLAResultResource {

		public SLAResult getProcessLastSLAResult(Long processId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getProcessLastSLAResultHttpResponse(processId);
			...
			try {
				return com.liferay.portal.workflow.metrics.rest.client.serdes.
					v1_0.SLAResultSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private SLAResultResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SLAResultResource.class.getName());
