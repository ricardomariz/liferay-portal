 ...
 */
@Generated("")
public interface SXPParameterContributorDefinitionResource {
	...
	public HttpInvoker.HttpResponse
			getSXPParameterContributorDefinitionsPageHttpResponse()
		throws Exception;

	public void postSXPParameterContributorDefinitionsPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSXPParameterContributorDefinitionsPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public SXPParameterContributorDefinitionResource build() {
	...
	public static class SXPParameterContributorDefinitionResourceImpl
		implements SXPParameterContributorDefinitionResource {
		...
		public Page<SXPParameterContributorDefinition>
			...
			try {
				return Page.of(
					content, SXPParameterContributorDefinitionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private SXPParameterContributorDefinitionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SXPParameterContributorDefinitionResource.class.getName());
