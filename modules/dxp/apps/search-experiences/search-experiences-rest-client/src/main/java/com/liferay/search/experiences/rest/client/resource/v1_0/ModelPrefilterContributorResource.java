 ...
 */
@Generated("")
public interface ModelPrefilterContributorResource {
	...
	public HttpInvoker.HttpResponse
			getModelPrefilterContributorsPageHttpResponse()
		throws Exception;

	public void postModelPrefilterContributorsPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postModelPrefilterContributorsPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public ModelPrefilterContributorResource build() {
			return new ModelPrefilterContributorResourceImpl(this);
		}
	...
	public static class ModelPrefilterContributorResourceImpl
		implements ModelPrefilterContributorResource {

		public Page<ModelPrefilterContributor>
			...
			try {
				return Page.of(content, ModelPrefilterContributorSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private ModelPrefilterContributorResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ModelPrefilterContributorResource.class.getName());
