...
public interface KeywordQueryContributorResource {
	...
	public HttpInvoker.HttpResponse
			getKeywordQueryContributorsPageHttpResponse()
		throws Exception;

	public void postKeywordQueryContributorsPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postKeywordQueryContributorsPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public KeywordQueryContributorResource build() {
			return new KeywordQueryContributorResourceImpl(this);
		}
	...
	public static class KeywordQueryContributorResourceImpl
		implements KeywordQueryContributorResource {
		...
		public Page<KeywordQueryContributor> getKeywordQueryContributorsPage()
			...
			try {
				return Page.of(content, KeywordQueryContributorSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private KeywordQueryContributorResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			KeywordQueryContributorResource.class.getName());
