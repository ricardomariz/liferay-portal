...
public interface SearchIndexResource {
	...
	public HttpInvoker.HttpResponse getSearchIndexesPageHttpResponse()
		throws Exception;

	public void postSearchIndexesPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSearchIndexesPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public SearchIndexResource build() {
	...
	public static class SearchIndexResourceImpl implements SearchIndexResource {

		public Page<SearchIndex> getSearchIndexesPage() throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getSearchIndexesPageHttpResponse();
			...
			try {
				return Page.of(content, SearchIndexSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private SearchIndexResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SearchIndexResource.class.getName());
