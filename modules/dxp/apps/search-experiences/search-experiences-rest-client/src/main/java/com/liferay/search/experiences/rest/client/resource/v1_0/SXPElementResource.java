...
public interface SXPElementResource {
	...
	public void postSXPElementsPageExportBatch(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse postSXPElementsPageExportBatchHttpResponse(
			String search, String filterString, String sortString,
			String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getSXPElementByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putSXPElementByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, SXPElement sxpElement)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postSXPElementPreviewHttpResponse(
			SXPElement sxpElement)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putSXPElementHttpResponse(
			Long sxpElementId, SXPElement sxpElement)
		throws Exception;
	...
	public static class SXPElementResourceImpl implements SXPElementResource {
		...
		public void postSXPElementsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSXPElementsPageExportBatchHttpResponse(
		...
		public SXPElement postSXPElementPreview(SXPElement sxpElement)
			...
			HttpInvoker.HttpResponse httpResponse =
				postSXPElementPreviewHttpResponse(sxpElement);
		...
		public SXPElement postSXPElementValidate(String string)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postSXPElementValidateHttpResponse(string);
		...
		public SXPElement putSXPElement(
			...
			HttpInvoker.HttpResponse httpResponse = putSXPElementHttpResponse(
				sxpElementId, sxpElement);
		...
		public SXPElement postSXPElementCopy(Long sxpElementId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postSXPElementCopyHttpResponse(sxpElementId);
