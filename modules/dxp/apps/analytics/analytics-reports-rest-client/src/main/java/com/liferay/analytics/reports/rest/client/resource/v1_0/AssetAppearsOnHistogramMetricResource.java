...
public interface AssetAppearsOnHistogramMetricResource {
	...
	public static class Builder {
		...
		public AssetAppearsOnHistogramMetricResource build() {
			return new AssetAppearsOnHistogramMetricResourceImpl(this);
		}
	...
	public static class AssetAppearsOnHistogramMetricResourceImpl
		...
		public AssetAppearsOnHistogramMetric
			...
			try {
				return AssetAppearsOnHistogramMetricSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private AssetAppearsOnHistogramMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AssetAppearsOnHistogramMetricResource.class.getName());
