...
public interface AssetHistogramMetricResource {
	...
	public static class Builder {
		...
		public AssetHistogramMetricResource build() {
			return new AssetHistogramMetricResourceImpl(this);
		}
	...
	public static class AssetHistogramMetricResourceImpl
		implements AssetHistogramMetricResource {
		...
		private AssetHistogramMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AssetHistogramMetricResource.class.getName());
