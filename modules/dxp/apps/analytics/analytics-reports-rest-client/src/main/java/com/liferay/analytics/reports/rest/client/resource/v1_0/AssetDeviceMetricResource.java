...
public interface AssetDeviceMetricResource {
	...
	public static class Builder {
		...
		public AssetDeviceMetricResource build() {
			return new AssetDeviceMetricResourceImpl(this);
		}
	...
	public static class AssetDeviceMetricResourceImpl
		...
		public AssetDeviceMetric getGroupAssetMetricAssetTypeDevice(
			...
			try {
				return AssetDeviceMetricSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private AssetDeviceMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AssetDeviceMetricResource.class.getName());
