...
public interface WebKeys {
	...
	public static final String ASSET_ENTRY_ABSTRACT_LENGTH =
		"ASSET_ENTRY_ABSTRACT_LENGTH";

	public static final String ASSET_ENTRY_VIEW_URL = "ASSET_ENTRY_VIEW_URL";

	public static final String ASSET_LAYOUT_TAG_NAMES =
		"ASSET_LAYOUT_TAG_NAMES";

	public static final String ASSET_RENDERER = "ASSET_RENDERER";

	public static final String ASSET_RENDERER_FACTORY =
		"ASSET_RENDERER_FACTORY";

	public static final String ASSET_RENDERER_FACTORY_CLASS_TYPE_ID =
		"ASSET_RENDERER_FACTORY_CLASS_TYPE_ID";
	...
	public static final String BROWSER_SNIFFER_REVISION =
		"BROWSER_SNIFFER_REVISION";

	public static final String BROWSER_SNIFFER_VERSION =
		"BROWSER_SNIFFER_VERSION";

	public static final String CACHE_PORTLET_RESPONSES =
		"CACHE_PORTLET_RESPONSES";
	...
	public static final String CONFIGURATION_ACTION_PATH =
		"CONFIGURATION_ACTION_PATH";

	public static final String CONTROL_PANEL_CATEGORIES_MAP =
		"CONTROL_PANEL_CATEGORIES_MAP";
	...
	public static final String DOCUMENT_LIBRARY_FILE_ENTRIES =
		"DOCUMENT_LIBRARY_FILE_ENTRIES";

	public static final String DOCUMENT_LIBRARY_FILE_ENTRY =
		"DOCUMENT_LIBRARY_FILE_ENTRY";

	public static final String DOCUMENT_LIBRARY_FILE_ENTRY_TYPE =
		"DOCUMENT_LIBRARY_FILE_ENTRY_TYPE";

	public static final String DOCUMENT_LIBRARY_FILE_SHORTCUT =
		"DOCUMENT_LIBRARY_FILE_SHORTCUT";

	public static final String DOCUMENT_LIBRARY_FILE_SHORTCUTS =
		"DOCUMENT_LIBRARY_FILE_SHORTCUTS";

	public static final String DOCUMENT_LIBRARY_FILE_VERSION =
		"DOCUMENT_LIBRARY_FILE_VERSION";

	public static final String DOCUMENT_LIBRARY_FOLDER =
		"DOCUMENT_LIBRARY_FOLDER";

	public static final String DOCUMENT_LIBRARY_FOLDERS =
		"DOCUMENT_LIBRARY_FOLDERS";

	public static final String DOCUMENT_LIBRARY_REPOSITORY =
	...
	public static final String FACEBOOK_CANVAS_PAGE_URL =
		"FACEBOOK_CANVAS_PAGE_URL";

	public static final String FACEBOOK_INCOMPLETE_USER_ID =
	...
	public static final String FORGOT_PASSWORD_REMINDER_USER =
		"FORGOT_PASSWORD_REMINDER_USER";

	public static final String FORGOT_PASSWORD_REMINDER_USER_EMAIL_ADDRESS =
		"FORGOT_PASSWORD_REMINDER_USER_EMAIL_ADDRESS";

	public static final String FORM_NAME = "FORM_NAME";

	public static final String FORM_NAVIGATOR_SECTION_SHOW =
	...
	public static final String JOURNAL_ARTICLE_CONTENT =
		"JOURNAL_ARTICLE_CONTENT";

	public static final String JOURNAL_ARTICLE_CONTENT_EL =
		"JOURNAL_ARTICLE_CONTENT_EL";

	public static final String JOURNAL_ARTICLE_DISPLAY =
		"JOURNAL_ARTICLE_DISPLAY";

	public static final String JOURNAL_ARTICLE_GROUP_ID =
		"JOURNAL_ARTICLE_GROUP_ID";
	...
	public static final String JOURNAL_RECENT_ARTICLES =
		"JOURNAL_RECENT_ARTICLES";

	public static final String JOURNAL_RECENT_DYNAMIC_DATA_MAPPING_STRUCTURES =
		"JOURNAL_RECENT_DYNAMIC_DATA_MAPPING_STRUCTURES";

	public static final String JOURNAL_RECENT_DYNAMIC_DATA_MAPPING_TEMPLATES =
		"JOURNAL_RECENT_DYNAMIC_DATA_MAPPING_TEMPLATES";

	public static final String JOURNAL_STRUCTURE = "JOURNAL_STRUCTURE";

	public static final String JOURNAL_STRUCTURE_CLOSE_DROPPABLE_TAG =
		"JOURNAL_STRUCTURE_CLOSE_DROPPABLE_TAG";

	public static final String JOURNAL_STRUCTURE_EL = "JOURNAL_STRUCTURE_EL";

	public static final String JOURNAL_STRUCTURE_EL_CONTENT =
		"JOURNAL_STRUCTURE_EL_CONTENT";

	public static final String JOURNAL_STRUCTURE_EL_COUNT =
		"JOURNAL_STRUCTURE_EL_COUNT";

	public static final String JOURNAL_STRUCTURE_EL_DEPTH =
		"JOURNAL_STRUCTURE_EL_DEPTH";

	public static final String JOURNAL_STRUCTURE_EL_INDEX_TYPE =
		"JOURNAL_STRUCTURE_EL_INDEX_TYPE";

	public static final String JOURNAL_STRUCTURE_EL_INSTANCE_ID =
		"JOURNAL_STRUCTURE_EL_INSTANCE_ID";

	public static final String JOURNAL_STRUCTURE_EL_LANGUAGE_ID =
		"JOURNAL_STRUCTURE_EL_LANGUAGE_ID";

	public static final String JOURNAL_STRUCTURE_EL_META_DATA =
		"JOURNAL_STRUCTURE_EL_META_DATA";

	public static final String JOURNAL_STRUCTURE_EL_NAME =
		"JOURNAL_STRUCTURE_EL_NAME";

	public static final String JOURNAL_STRUCTURE_EL_PARENT_ID =
		"JOURNAL_STRUCTURE_EL_PARENT_ID";

	public static final String JOURNAL_STRUCTURE_EL_REPEAT_COUNT_MAP =
		"JOURNAL_STRUCTURE_EL_REPEAT_COUNT_MAP";

	public static final String JOURNAL_STRUCTURE_EL_REPEATABLE =
		"JOURNAL_STRUCTURE_EL_REPEATABLE";

	public static final String JOURNAL_STRUCTURE_EL_REPEATABLE_PROTOTYPE =
		"JOURNAL_STRUCTURE_EL_REPEATABLE_PROTOTYPE";

	public static final String JOURNAL_STRUCTURE_EL_SIBLINGS =
		"JOURNAL_STRUCTURE_EL_SIBLINGS";

	public static final String JOURNAL_STRUCTURE_EL_TYPE =
		"JOURNAL_STRUCTURE_EL_TYPE";
	...
	public static final String MAIL_MESSAGE_ATTACHMENTS =
	...
	public static final String MAIL_MESSAGE_IN_REPLY_TO =
		"MAIL_MESSAGE_IN_REPLY_TO";

	public static final String MAIL_MESSAGE_ORIGINAL_ID =
		"MAIL_MESSAGE_ORIGINAL_ID";

	public static final String MAIL_MESSAGE_RECIPIENTS =
		"MAIL_MESSAGE_RECIPIENTS";

	public static final String MAIL_MESSAGE_REFERENCES =
		"MAIL_MESSAGE_REFERENCES";
	...
	public static final String MESSAGE_BOARDS_CATEGORY =
		"MESSAGE_BOARDS_CATEGORY";

	public static final String MESSAGE_BOARDS_MESSAGE =
		"MESSAGE_BOARDS_MESSAGE";

	public static final String MESSAGE_BOARDS_MESSAGE_DISPLAY =
		"MESSAGE_BOARDS_MESSAGE_DISPLAY";

	public static final String MESSAGE_BOARDS_TREE_INDEX =
		"MESSAGE_BOARDS_TREE_INDEX";

	public static final String MESSAGE_BOARDS_TREE_WALKER =
		"MESSAGE_BOARDS_TREE_WALKER";

	public static final String MESSAGE_BOARDS_TREE_WALKER_CATEGORY =
		"MESSAGE_BOARDS_TREE_WALKER_CATEGORY";

	public static final String MESSAGE_BOARDS_TREE_WALKER_CUR_MESSAGE =
		"MESSAGE_BOARDS_TREE_WALKER_CUR_MESSAGE";

	public static final String MESSAGE_BOARDS_TREE_WALKER_DEPTH =
		"MESSAGE_BOARDS_TREE_WALKER_DEPTH";

	public static final String MESSAGE_BOARDS_TREE_WALKER_LAST_NODE =
		"MESSAGE_BOARDS_TREE_WALKER_LAST_NODE";

	public static final String MESSAGE_BOARDS_TREE_WALKER_SEL_MESSAGE =
		"MESSAGE_BOARDS_TREE_WALKER_SEL_MESSAGE";

	public static final String MESSAGE_BOARDS_TREE_WALKER_THREAD =
		"MESSAGE_BOARDS_TREE_WALKER_THREAD";

	public static final String MESSAGE_BOARDS_TREE_WALKER_THREAD_FLAG =
		"MESSAGE_BOARDS_TREE_WALKER_THREAD_FLAG";
	...
	public static final String PLUGIN_REPOSITORY_REPORT =
		"PLUGIN_REPOSITORY_REPORT";

	public static final String PLUGIN_THEMES = "PLUGIN_THEMES";

	public static final String PORTAL_MESSAGES =
	...
	public static final String PORTLET_BREADCRUMBS =
		"LIFERAY_SHARED_PORTLET_BREADCRUMBS";

	public static final String PORTLET_CATEGORY = "PORTLET_CATEGORY";

	public static final String PORTLET_CATEGORY_INDEX =
		"PORTLET_CATEGORY_INDEX";
	...
	public static final String PORTLET_QUICK_ACCESS_ENTRIES =
		"LIFERAY_SHARED_PORTLET_QUICK_ACCESS_ENTRIES";

	public static final String PORTLET_RENDER_PARAMETERS =
	...
	public static final String PUBLIC_RENDER_PARAMETER_CONFIGURATIONS =
		"PUBLIC_RENDER_PARAMETER_CONFIGURATIONS";

	public static final String PUBLIC_RENDER_PARAMETERS =
		"PUBLIC_RENDER_PARAMETERS";

	public static final String PUBLIC_RENDER_PARAMETERS_POOL =
		"PUBLIC_RENDER_PARAMETERS_POOL_";

	public static final String REDIRECT = "REDIRECT";

	public static final String REDIRECT_TO_DEFAULT_LAYOUT =
	...
	public static final String RENDER_PORTLET_BOUNDARY =
		"RENDER_PORTLET_BOUNDARY";

	public static final String RENDER_PORTLET_COLUMN_COUNT =
		"RENDER_PORTLET_COLUMN_COUNT";

	public static final String RENDER_PORTLET_COLUMN_ID =
	...
	public static final String SEARCH_CONTAINER_RESULT_ROW_CHECKER =
		"SEARCH_CONTAINER_RESULT_ROW_CHECKER";

	public static final String SEARCH_CONTAINER_RESULT_ROW_ENTRY =
		"SEARCH_CONTAINER_RESULT_ROW_ENTRY";
	...
	public static final String SERVLET_CONTEXT_INCLUDE_FILTER_PATH =
		"SERVLET_CONTEXT_INCLUDE_FILTER_PATH";

	public static final String SERVLET_CONTEXT_INCLUDE_FILTER_STRICT =
	...
	public static final String SETUP_WIZARD_DEFAULT_LOCALE =
		"SETUP_WIZARD_DEFAULT_LOCALE";

	public static final String SETUP_WIZARD_PASSWORD_UPDATED =
		"SETUP_WIZARD_PASSWORD_UPDATED";

	public static final String SETUP_WIZARD_PROPERTIES =
		"SETUP_WIZARD_PROPERTIES";

	public static final String SETUP_WIZARD_PROPERTIES_FILE_CREATED =
		"SETUP_WIZARD_PROPERTIES_FILE_CREATED";
	...
	public static final String SINGLE_PAGE_APPLICATION_LAST_PORTLET_ID =
		"SINGLE_PAGE_APPLICATION_LAST_PORTLET_ID";
	...
	public static final String TREE_RENDER_CHILDREN_ONLY =
		"TREE_RENDER_CHILDREN_ONLY";
	...
	public static final String VISITED_GROUP_ID_PREVIOUS =
		"LIFERAY_SHARED_VISITED_GROUP_ID_PREVIOUS";

	public static final String VISITED_GROUP_ID_RECENT =
	...
	public static final String WORKFLOW_ASSET_PREVIEW =
