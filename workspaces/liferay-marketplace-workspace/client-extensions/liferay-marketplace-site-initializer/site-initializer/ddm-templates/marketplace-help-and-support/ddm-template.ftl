...
<#if (_CUSTOM_FIELD_Documentation.getData())?has_content && (_CUSTOM_FIELD_Documentation.getData())?starts_with("https")>
	...
	<a class="bg-white pb-2 pl-4 pr-4 pt-2 custom-class-662" href="${_CUSTOM_FIELD_Documentation.getData()}" target="_blank">
		<svg width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
			<mask id="doc" maskUnits="userSpaceOnUse" x="2" y="1" width="12" height="14">
				<path fill-rule="evenodd" clip-rule="evenodd" d="M2.673 2.666c0-.733.594-1.333 1.327-1.333h4.78c.353 0 .693.14.94.393l3.22 3.22c.253.247.393.587.393.94v7.447c0 .733-.6 1.333-1.333 1.333H3.993c-.733 0-1.326-.6-1.326-1.333l.006-10.667Zm5.994-.333v3c0 .367.3.667.666.667h3L8.667 2.333Z" fill="#000"></path>
			</mask>

			<g mask="url(#doc)">
				<path fill="var(--color-neutral-5)" d="M0 0h16v16H0z"></path>
			</g>
		</svg>

		<span class="copy-tsvgext ml-1">${languageUtil.get(locale, "installation-documentation", "Installation Documentation")}</span>

		<svg class="help-and-support-svg link-arrow ml-auto" width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<#if (_CUSTOM_FIELD_Source.getData())?has_content && (_CUSTOM_FIELD_Source.getData())?starts_with("https")>
	...
	<a class="bg-white pb-2 pl-4 pr-4 pt-2 custom-class-374" href="${_CUSTOM_FIELD_Source.getData()}" target="_blank">
		<svg width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="d-flex flex-column">
	<div class="d-flex mb-3">
		...
		<a class="d-flex w-100 justify-content-between help-and-support-link" onClick="openModal()">
			...
			<svg class="help-and-support-svg help-and-support-link-arrow link-arrow ml-auto" fill="none" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
				...
				<g mask="url(#arrow)">
					<path d="M0 0h16v16H0z" fill="var(--color-neutral-5)" />
				</g>
			</svg>
		</a>
	</div>
	...
	<div class="d-flex">
		...
		<a class="d-flex w-100 justify-content-between help-and-support-link" href="https://www.liferay.com/en/legal/marketplace-terms-of-service" target="_blank">
			...
			<svg class="help-and-support-svg help-and-support-link-arrow link-arrow ml-auto" fill="none" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
				...
				<g mask="url(#arrow)">
					<path fill="var(--color-neutral-5)" d="M0 0h16v16H0z" />
				</g>
			</svg>
		</a>
	</div>
			...
			<#if catalogName?has_content>
				<div class="align-items-center d-flex flex-row mb-3">
					<style ${nonceAttribute}>
						...
						.modal-icon-background img {
							height: 40px;
							object-fit: contain;
							width: 40px;
						}

						.modal-icon-background .lexicon-icon {
							fill: var(--secondary);
						}
					</style>
						...
						<#if solutionHeaderImages?has_content>
							<#list solutionHeaderImages as image>
								...
								<#if imageSourceSplitedUrl?has_content>
									...
									<img alt="Slide ${image?index}" class="catalog-icon" src="${productThumbnail}">
								</#if>
							</#list>
						<#else>
